...
$log=new Log("gettax-".date('Y-m-d').".log");
$log->write($value);
$log->write($tax_class_id);
...
$log=new Log("getrates.log");
$log->write("getrates");
$log->write($value);
$log->write($tax_class_id);
$log->write($this->tax_rates);
		if (isset($this->tax_rates[$tax_class_id])) {
$log->write("getrates if");
...
$log->write("getrates end");
$log->write($tax_rate_data);
