<?php
class Controllermposbmclorder extends Controller {
...
public function senddebitnote()
{
		$log=new Log("bcml-single-debitnote-send-".date('Y-m-d').".log");
				$this->adminmodel('pos/bcml');
$data['DebitNoteDetail'][] = array(
								'debitnoteno'=> '1343',
								'indentno'   => 2901306 ,
                                'invoiceno'   => 80578,
                                'invoicedate'       => date('Ymd', strtotime('2018-02-08 16:31:14')),
                                'username'       => 'Admin',
								'taggedvalue'=>number_format((float)(7411.1099), 2, '.', '')
                                );
