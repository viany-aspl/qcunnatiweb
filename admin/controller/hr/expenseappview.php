...
class ControllerHrExpenseappview extends Controller {
	private $error = array();
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('hr/expenseappview', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
	  ...
	  $this->load->model('setting/store');
		...
		$this->response->setOutput($this->load->view('hr/bill_list_for_approve_by_app_view.tpl', $data));
