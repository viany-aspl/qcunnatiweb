...
class ControllerFarmerrequestDsclcardsummaryreport extends Controller {
	private $error = array();

	public function index() {		

		$this->document->setTitle('DSCL Card Summary Report');
...
FROM
aspl_card_issue
where aspl_card_issue.CARD_STATUS IS NOT NULL ";


	
$cardsql.="GROUP BY aspl_card_issue.unit_id";
