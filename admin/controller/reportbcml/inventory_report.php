...
class ControllerReportbcmlInventoryReport extends Controller {
	...
	public function field_inventory_report() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/inventory_report/field_inventory_report', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
       ...
       // print_r($results);
		...
		$pagination->url = $this->url->link('reportbcml/inventory_report/field_inventory_report', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
//print_r($order_total); exit;
		...
		$this->response->setOutput($this->load->view('reportbcml/Inventory_fieldinventory_report.tpl', $data));
	}
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/inventory_report', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
 ...
 $results = $this->model_report_Inventory->getInventory_report($filter_data);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportbcml/inventory_report', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportbcml/Inventory_report.tpl', $data));
	}
...
public function linked_product() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/inventory_report/linked_product', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
 ...
 */
	...
	//echo "here";
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportbcml/inventory_report/linked_product', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportbcml/Inventory_linked_product.tpl', $data));
	}
...
public function product_wise()
        ...
        $data['breadcrumbs'][] = array(
            'text' => $this->language->get('heading_title'),
            'href' => $this->url->link('reportbcml/inventory_report/product_wise', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );
	   ...
	   $data["total_Qnty"] =$totalss["total_Qnty"] ;
        ...
        $pagination->page = $page;
        $pagination->limit = $this->config->get('config_limit_admin');
        $pagination->url = $this->url->link('reportbcml/inventory_report/product_wise', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('reportbcml/Inventory_report_product_wise.tpl', $data));
        }
