<?php
class ControllerReportbcmlProductStorewisesales extends Controller {
...
public function salescount() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/product_storewisesales/salescount', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportbcml/product_storewisesales/salescount', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportbcml/product_store_wise_sales_count.tpl', $data));
	}
...
$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/product_storewisesales', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportbcml/product_storewisesales', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportbcml/product_store_wise_sales.tpl', $data));
	}
