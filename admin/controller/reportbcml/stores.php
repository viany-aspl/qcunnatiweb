...
class ControllerReportbcmlStores extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'text' => "Store's Users",
			'href' => $this->url->link('reportbcml/stores', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportbcml/stores', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportbcml/view_stores.tpl', $data));
	}
