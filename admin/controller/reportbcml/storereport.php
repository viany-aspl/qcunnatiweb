 ...
 * @author agent
 */
class ControllerreportbcmlStorereport extends Controller {
...
/*********************************  end  Material received ****************************************/ 
                ...
                //if($this->request->get['tab']=="2"){
                            $order_total2 = $this->model_report_stock->getTotalOrders_companywise($filter_data2);

		$results2 = $this->model_report_stock->getOrders_companywise($filter_data2);
 ...
 /*****************************************SALE**********************************************/               
		   ...
		   //$results3 = $this->model_report_sale_summary->getSale_summary_category($filter_data3);
                               $results3 = $this->model_report_sale_summary->getSale_summary_subsidy_cashCompanywise($filter_data3);
...
/***************************************************AMOUNT DEPOSIT********************************/
    ...
    //if($this->request->get['tab']=="4"){
            ...
            $order_total4 = $this->model_report_cash->getTotalCash_transation_CompanyWise($filter_data4);
	    $bank_totals = $this->model_report_cash->get_bank_sum_cash_companywise($filter_data4);
	    $data['orders4'] = array();

	     $results4 = $this->model_report_cash->getCash_report_CompanyWise($filter_data4);
...
/***********************************current inventory************************************************/
                  ...
                  $data['orders6'] = array();
                   if ($this->request->get['filter_store']!="") {
                      $order_total6 = $this->model_report_Inventory->getTotalInventory_companywise($filter_data6);
                       $results6 = $this->model_report_Inventory->getInventory_report_companywise($filter_data6);
...
/***************************************** DATE WISE SALE**********************************************/               
                //if($this->request->get['tab']=="7"){
                   ...
                   $this->load->model('report/sale_summary');  
                   $t7=$this->model_report_sale_summary->getTotalSale_category_date_wise_companywise($filter_data7);
		   $order_total7 =$t7["total"] ;

		   $data['orders7'] = array();

		   $results7 = $this->model_report_sale_summary->getSale_summary_category_date_wise_companywise($filter_data7);
...
/***************************************** STORE EXPENSE START**********************************************/               
                //if($this->request->get['tab']=="8"){
                   ...
                   $order_total8 = $this->model_hr_hr->getTotalbill_companywise($filter_data8);
	 
		$results8 = $this->model_hr_hr->getBills_companywise($filter_data8);
...
$this->load->model('setting/store');       
		...
		$pagination->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page={page}&tab=1', 'SSL');
		...
		$pagination2->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page2={page}&tab=2', 'SSL');
		...
		$pagination3->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page3={page}&tab=3', 'SSL');
		...
		$pagination4->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page4={page}&tab=4', 'SSL');
		...
		$pagination5->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page5={page}&tab=5', 'SSL');
		...
		$pagination6->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page6={page}&tab=6', 'SSL');
		...
		$pagination7->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page7={page}&tab=7', 'SSL');
		...
		$pagination8->url = $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url . '&page8={page}&tab=8', 'SSL');
      ...
      $data['breadcrumbs'] = array();
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Store  Report',
			'href' => $this->url->link('reportbcml/storereport', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$data['footer'] = $this->load->controller('common/footer');
          $this->response->setOutput($this->load->view('reportbcml/storereport.tpl', $data));
