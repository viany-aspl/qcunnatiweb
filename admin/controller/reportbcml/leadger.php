<?php
class ControllerReportbcmlLeadger extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/product_purchased', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportbcml/leadger', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		if(($data['store_type_id']=="1") || ($data['store_type_id']=="2"))
		{
		  $this->response->setOutput($this->load->view('reportbcml/store_lazer_own.tpl', $data));
		}
		else
		{
                              $this->response->setOutput($this->load->view('reportbcml/store_lazer_franchise.tpl', $data));
		}
	}
	...
	public function download_pdf() {
		...
		if(($data['store_type_id']=="1") || ($data['store_type_id']=="2"))
		{
		  //$this->response->setOutput($this->load->view('reportbcml/store_ledger_pdf_own.tpl', $data));
		}
		else
		{
                              //$this->response->setOutput($this->load->view('reportbcml/store_ledger_pdf_franchise.tpl', $data));
		}
		...
		{
		  	//$this->response->setOutput($this->load->view('reportbcml/store_ledger_pdf_own.tpl', $data));
			$html=$this->load->view('reportbcml/store_ledger_pdf_own.tpl', $data);
		}
		else
		{
                              	//$this->response->setOutput($this->load->view('report/store_ledger_pdf_franchise.tpl', $data));
			$html=$this->load->view('reportbcml/store_ledger_pdf_franchise.tpl', $data);
		}
