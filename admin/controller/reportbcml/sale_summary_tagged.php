...
class ControllerReportbcmlSaleSummaryTagged extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Sale Summary',
			'href' => $this->url->link('reportbcml/sale_summary_tagged', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportbcml/sale_summary_tagged', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportbcml/sale_summary_tagged.tpl', $data));
	}
