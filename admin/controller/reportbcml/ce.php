...
class ControllerReportbcmlCe extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/ce', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportbcml/ce', 'token=' . $this->session->data['token'] . $url . '&page1={page}&tab=tab1&page2='.$page2, 'SSL');
...
//////////////////////////////////////////////tab 2 start here//////////////////////////
		...
		$pagination2->url = $this->url->link('reportbcml/ce', 'token=' . $this->session->data['token'] . $url . '&page2={page}&tab=tab2&page1='.$page1, 'SSL');
		...
		$this->response->setOutput($this->load->view('reportbcml/ce_report.tpl', $data));
	}
...
public function runner() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportbcml/cash_report/runner', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
