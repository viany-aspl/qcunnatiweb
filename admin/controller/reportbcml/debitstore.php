<?php
class ControllerreportbcmlDebitstore extends Controller {
	private $error = array();
...
$data['breadcrumbs'][] = array(
'text' => 'Waiver Report',
'href' => $this->url->link('reportbcml/debitstore/waiver _report', 'token=' . $this->session->data['token'] , 'SSL')
);
$data['token'] = $this->session->data['token'];
$this->load->model('setting/store');
$data['order_stores'] = $this->model_setting_store->getStoresCompanyWise('2');
...
$pagination->url = $this->url->link('reportbcml/debitstore/waiver _report', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$this->response->setOutput($this->load->view('reportbcml/Waiver_Report.tpl', $data));
}
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$data['breadcrumbs'][] = array(
'text' => 'Expense Report',
'href' => $this->url->link('reportbcml/debitstore/getWaveoffdata', 'token=' . $this->session->data['token'] , 'SSL')
);
$data['token'] = $this->session->data['token'];
$this->load->model('setting/store');
$data['order_stores'] = $this->model_setting_store->getStoresCompanyWise('2');
...
$pagination->page = $page;
$pagination->limit = $this->config->get('config_limit_admin');
$pagination->url = $this->url->link('reportbcml/debitstore/getWaveoffdata', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$this->response->setOutput($this->load->view('reportbcml/wave_offdtl_list.tpl', $data));
}
