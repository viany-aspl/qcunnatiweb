<?php
class ControllerTagposTagpos extends Controller {
	private $error = array();  

	public function index() 
	{
		$this->load->language('setting/store');
		$this->document->setTitle('Tag POS');
	...
	private function search_indent_excel()
	{
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Tag POS',
			'href' => $this->url->link('tapos/tagpos', 'token=' . $this->session->data['token'], 'SSL')
		);
		...
		$this->response->setOutput($this->load->view('tagpos/add_tag_order.tpl', $data));
	}
