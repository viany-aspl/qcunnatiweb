...
class ControllerReportisecSaleSummary extends Controller {
...
public function subsidycash() {
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Sale Summary(Category)',
			'href' => $this->url->link('reportisec/sale_summary/subsidycash', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
...
//print_r($data['orders']);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportisec/sale_summary/subsidycash', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportisec/sale_summary_subsidycash.tpl', $data));
	}
//////////////////////////////////////////////
...
public function sale_summary() {
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Sale Summary(Category)',
			'href' => $this->url->link('reportisec/sale_summary/sale_summary', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportisec/sale_summary/sale_summary', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportisec/sale_summary/sale_summary.tpl', $data));
	}
//////////////////////////////////////////////
