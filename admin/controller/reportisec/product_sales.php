...
class ControllerReportisecProductSales extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportisec/sale_order', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
...
//exit;
		...
		$pagination->url = $this->url->link('reportisec/product_sales', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportisec/product_sales.tpl', $data));
	}
