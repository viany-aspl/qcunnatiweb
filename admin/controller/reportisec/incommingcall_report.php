<?php
class ControllerReportisecIncommingcallreport extends Controller {
	public function index() {
		...
		$results = $this->model_report_incommingcall_report->getCustomerActivities($filter_data);
		//$activity_total =sizeof($results);
...
'Busy'=>$result['Busy'],
'Not_reachable'=>$result['Not_reachable'],
'Attempt_Later'=>$result['Attempt_Later'],
'Not_Interested'=>$result['Not_Interested'],
'Switch_Off'=>$result['Switch_Off'],
'Not_Picking'=>$result['Not_Picking'],
'Enquiry_Status'=>$result['Enquiry_Status'],
'General_Call'=>$result['General_Call']
