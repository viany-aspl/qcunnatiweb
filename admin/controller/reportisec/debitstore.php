<?php
class ControllerreportisecDebitstore extends Controller {
	private $error = array();
...
$data['breadcrumbs'][] = array(
'text' => 'Waiver Report',
'href' => $this->url->link('reportisec/debitstore/waiver _report', 'token=' . $this->session->data['token'] , 'SSL')
);
$data['token'] = $this->session->data['token'];
$this->load->model('setting/store');
...
$pagination->url = $this->url->link('reportisec/debitstore/waiver _report', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$this->response->setOutput($this->load->view('reportisec/Waiver_Report.tpl', $data));
}
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
$data['breadcrumbs'][] = array(
'text' => 'Expense Report',
'href' => $this->url->link('reportisec/debitstore/getWaveoffdata', 'token=' . $this->session->data['token'] , 'SSL')
);
$data['token'] = $this->session->data['token'];
$this->load->model('setting/store');
$data['order_stores'] = $this->model_setting_store->getStoresCompanyWise('3');
...
$pagination->page = $page;
$pagination->limit = $this->config->get('config_limit_admin');
$pagination->url = $this->url->link('reportisec/debitstore/getWaveoffdata', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
...
$this->response->setOutput($this->load->view('reportisec/wave_offdtl_list.tpl', $data));
}
