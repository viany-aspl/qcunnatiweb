 ...
 * @author agent
 */
class ControllerreportisecStorereport extends Controller {
...
$this->load->model('setting/store');       
		...
		$pagination->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page={page}&tab=1', 'SSL');
		...
		$pagination2->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page2={page}&tab=2', 'SSL');
		...
		$pagination3->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page3={page}&tab=3', 'SSL');
		...
		$pagination4->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page4={page}&tab=4', 'SSL');
		...
		$pagination5->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page5={page}&tab=5', 'SSL');
		...
		$pagination6->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page6={page}&tab=6', 'SSL');
		...
		$pagination7->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page7={page}&tab=7', 'SSL');
		...
		$pagination8->url = $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url . '&page8={page}&tab=8', 'SSL');
      ...
      $data['breadcrumbs'] = array();
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Store  Report',
			'href' => $this->url->link('reportisec/storereport', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$data['footer'] = $this->load->controller('common/footer');
          $this->response->setOutput($this->load->view('reportisec/storereport.tpl', $data));
