...
class ControllerreportisecExpenseapprove extends Controller {
	private $error = array();
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportisec/expenseapprove', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
 	  ...
 	  $mcrypt=new MCrypt();
		...
		$pagination->url = $this->url->link('reportisec/expenseapprove', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportisec/bill_list_for_approve.tpl', $data));
...
include_once '../system/library/PHPExcel.php';
	...
	$mcrypt=new MCrypt();
            if ($this->request->get['bill_id'] != '')
            {
                ...
                $this->response->redirect($this->url->link('reportisec/expenseapprove', 'token=' . $this->session->data['token'] . $url, 'SSL'));
                }
                else 
                {
