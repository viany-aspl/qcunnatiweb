...
class ControllerReportisecCashReport extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportisec/cash_report', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportisec/cash_report', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['allces']=$this->model_runner_cash->getCeByCompany(array('filter_company'=>'3'));
		...
		$this->response->setOutput($this->load->view('reportisec/cash_report.tpl', $data));
	}
    ...
    $objWriter->save('php://output');
	   ...
	   public function cash_position()
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportisec/cash_report/cash_position', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
	  ...
	  $order_total = $arr["total"];
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportisec/cash_report/cash_position', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
                $this->response->setOutput($this->load->view('reportisec/cash_position.tpl', $data));
        }
...
if($data['bank_id']=="6")
    ...
    $mail             = new PHPMailer();
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportisec/cash_report/runner_cash_position', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
	   ...
	   //echo "here";
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportisec/cash_report/runner_cash_position', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
                $this->response->setOutput($this->load->view('reportisec/ce_current_report.tpl', $data));
        }
