...
class ControllerreportisecBillsubmission extends Controller {
	private $error = array();
	...
	public function index() { //print_r($this->request->post);exit;
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportisec/billsubmission/getlist', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$filter_data = array(
			...
			'limit'                  => $this->config->get('config_limit_admin')
                ...
                $order_total = $this->model_tag_order->getTotalbill_companywise($filter_data);

		$results = $this->model_tag_order->getBills_companywise($filter_data);
		...
		$pagination->url = $this->url->link('reportisec/billsubmission/getlist', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportisec/bill_list_view.tpl', $data));
