<?php
class ControllerIsecStorequantity extends Controller {
...
$data['config_tax_included'] = $this->config->get('config_tax_included');
	...
	protected function getForm() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('isec/store_quantity', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		if (!isset($this->request->get['product_id'])) {
			//$data['action'] = $this->url->link('isec/product/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('isec/store_quantity/edit', 'token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
		}
		...
		{
		$data['stores'] = $this->model_setting_store->getStoresByUser(array('filter_user'=>$this->user->getId()));
		}
		else
		{
		$data['stores'] = $this->model_setting_store->getIsecStores();
		}
		if (isset($this->request->post['product_store'])) {
			...
			$data['product_store_quantity'] = $this->model_catalog_product->getIsecProductStoresQuantity($this->request->get['product_id']);
		} else {
		...
		$this->response->setOutput($this->load->view('isec/store_quantity_form.tpl', $data));
	}

	protected function validateForm() {
		if (!$this->user->hasPermission('modify', 'isec/store_quantity')) {
