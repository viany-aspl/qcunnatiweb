...
class ControllerLeadOrderleads extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_addeddby'])) {
			$filter_addeddby = $this->request->get['filter_addeddby'];
		} else {
			$filter_addeddby = null;
		}
		...
		if (isset($this->request->get['filter_addeddby'])) {
			$url .= '&filter_addeddby=' . $this->request->get['filter_addeddby'];
		}
		...
		$filter_data = array(
			...
			'filter_total'         => $filter_total,
                                          'filter_addeddby'         => $filter_addeddby,
...
$date_potential_temp=date($this->language->get('date_format_short'), strtotime($result['date_potential']));
			...
			$data['orders'][] = array(
				...
				'aTotal'         => $this->currency->format($result['aTotal'], $result['currency_code'], $result['currency_value']),
				'date_added'    => date($this->language->get('date_format_short'), strtotime($result['date_added'])),
				'date_modified' => date($this->language->get('date_format_short'), strtotime($result['date_modified'])),
                                                        'date_potential'=> $date_potential_temp,
                                                        'ase_name'=> $result['firstnamea']." ".$result['lastnamea'],
...
//echo $filter_addedby;
		...
		$data['filter_total'] = $filter_total;
                            $data['filter_addeddby'] = $filter_addeddby;
...
$results = $this->model_lead_orderleads->getOrders($filter_data);
    ...
    { 
        ...
        //echo $product_info_string;
           ...
           $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $row, $data['firstnamea']." ".$data['lastnamea']);
  //'ase_name'=> $result['firstnamea']." ".$result['lastnamea'],
        $row++;
    }
    //exit;
