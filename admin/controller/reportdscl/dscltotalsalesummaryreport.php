...
class ControllerreportdsclDscltotalsalesummaryreport extends Controller {
	private $error = array();
...
SUM(Total) AS requsition,
SUM(CASE WHEN PAYMENT_METHOD = ('Tagged') THEN Total ELSE 0 END) AS request,
SUM(CASE WHEN PAYMENT_METHOD = ('Tagged Cash') THEN Total ELSE 0 END) AS printing,
SUM(CASE WHEN PAYMENT_METHOD = ('Cash Subsidy') THEN 1 ELSE 0 END) AS printed
FROM
...
//echo $cardsql;
		...
		$this->response->setOutput($this->load->view('reportdscl/dscltotalsalesummaryreport.tpl', $data));
}
