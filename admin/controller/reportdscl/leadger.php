<?php
class ControllerReportdsclLeadger extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/product_purchased', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		if($filter_stores_id!="")
		{
			if(($data['store_type_id']=="1") || ($data['store_type_id']=="1"))
			{
		...
		$pagination->url = $this->url->link('reportdscl/leadger', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		{
		  $this->response->setOutput($this->load->view('reportdscl/store_lazer_own.tpl', $data));
		}
		else
		{
                              $this->response->setOutput($this->load->view('reportdscl/store_lazer_franchise.tpl', $data));
		}
	}
	...
	public function download_pdf() {
		...
		if(($data['store_type_id']=="1") || ($data['store_type_id']=="2"))
		{
		  //$this->response->setOutput($this->load->view('reportdscl/store_ledger_pdf_own.tpl', $data));
		}
		else
		{
                              //$this->response->setOutput($this->load->view('reportdscl/store_ledger_pdf_franchise.tpl', $data));
		}
		...
		if(($data['store_type_id']=="1") || ($data['store_type_id']=="2"))
		{
			...
			$html=$this->load->view('reportdscl/store_ledger_pdf_own.tpl', $data);
		}
		else
		{
                              	//$this->response->setOutput($this->load->view('report/store_ledger_pdf_franchise.tpl', $data));
			$html=$this->load->view('reportdscl/store_ledger_pdf_franchise.tpl', $data);
		}
