...
class ControllerReportdsclProductSales extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/sale_order', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
...
//exit;
		...
		$pagination->url = $this->url->link('reportdscl/product_sales', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportdscl/product_sales.tpl', $data));
	}
