<?php
class ControllerReportbcmlIncommingcallanswer extends Controller {
	public function index() {
		...
		$activity_total = $this->model_report_incommingcall_report->getTotalCustomerActivities($filter_data);

		$results = $this->model_report_incommingcall_report->incomingcall_answer($filter_data);
		...
		$this->response->setOutput($this->load->view('report/incommingcall_answer.tpl', $data));
	}
