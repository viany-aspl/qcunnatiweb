...
class ControllerReportdsclOrdertagged extends Controller {
	private $error = array();
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);

		$data['invoice'] = $this->url->link('reportdscl/order_tagged/invoice', 'token=' . $this->session->data['token'], 'SSL');
		$data['shipping'] = $this->url->link('reportdscl/order_tagged/shipping', 'token=' . $this->session->data['token'], 'SSL');
		$data['insert'] = $this->url->link('reportdscl/order_tagged/add', 'token=' . $this->session->data['token'], 'SSL');
...
$filter_data = array(
		...
		foreach ($results as $result) { //print_r($result);
			...
			$data['orders'][] = array(
				...
				'view'          => $this->url->link('reportdscl/order_tagged/info', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL'),
				'edit'          => $this->url->link('reportdscl/order_tagged/edit', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL'),
				'invoice'        => $this->url->link('reportdscl/order_tagged/invoice', 'token=' . $this->session->data['token'] . '&order_id=' . $result['order_id'] . $url, 'SSL'),
		...
		$data['sort_order'] = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
		$data['sort_customer'] = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_total'] = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
		$data['sort_date_potential'] = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . '&sort=o.date_potential' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportdscl/order_list_tagged.tpl', $data));
	}
...
///////////////////////////////////create tag bill in one click end here//////////////////////   
	...
	public function info() {
		...
		if ($order_info) {
			...
			$data['shipping'] = $this->url->link('reportdscl/order_tagged/shipping', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
			$data['invoice'] = $this->url->link('reportdscl/order_tagged/invoice', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
			$data['edit'] = $this->url->link('reportdscl/order_tagged/edit', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
			$data['cancel'] = $this->url->link('reportdscl/order_tagged', 'token=' . $this->session->data['token'] . $url, 'SSL');
