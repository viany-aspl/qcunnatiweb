...
class ControllerReportdsclCe extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/ce', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportdscl/ce', 'token=' . $this->session->data['token'] . $url . '&page1={page}&tab=tab1&page2='.$page2, 'SSL');
...
//////////////////////////////////////////////tab 2 start here//////////////////////////
		...
		$pagination2->url = $this->url->link('reportdscl/ce', 'token=' . $this->session->data['token'] . $url . '&page2={page}&tab=tab2&page1='.$page1, 'SSL');
		...
		$data['allces']=$this->model_runner_cash->getCeByCompany(array('filter_company'=>'1'));
		$data['header'] = $this->load->controller('common/header'); 
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
                           // $mcrypt=new MCrypt();
                            //echo $mcrypt->decrypt('7e126d01d0362588e0122c1eac729bdf9277ec1faa37dc20da4821ae901e23ff'); 
		$this->response->setOutput($this->load->view('reportdscl/ce_report.tpl', $data));
	}
...
public function runner() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/cash_report/runner', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
