...
class ControllerReportdsclStock extends Controller {
	public function transfer() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/stock/transfer', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportdscl/stock/transfer', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportdscl/stock_transfer.tpl', $data));
	}
	public function transit() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/stock/transit', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportdscl/stock/transit', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
                $data['filter_name']= $filter_name;
                $data['filter_name_id']= $filter_name_id;
		$this->response->setOutput($this->load->view('reportdscl/stock_transit.tpl', $data));
	}
 ...
 public function download_transit() {
   ...
   public function recived() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('reportdscl/stock/recived', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('reportdscl/stock/recived', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
                $data['filter_name']= $filter_name;
                $data['filter_name_id']= $filter_name_id;
		$this->response->setOutput($this->load->view('reportdscl/stock_recived.tpl', $data));
	}
...
if($data['store_name']!="")
	...
	public function transit_po() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('reportdscl/stock/po_transit', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );
        ...
        $pagination->page = $page;
        $pagination->limit = $this->config->get('config_limit_admin');
        $pagination->url = $this->url->link('reportdscl/stock/transit_po', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $data['footer'] = $this->load->controller('common/footer');
                $data['filter_name']= $filter_name;
                $data['filter_name_id']= $filter_name_id;
        $this->response->setOutput($this->load->view('reportdscl/po_transit.tpl', $data));
    }
