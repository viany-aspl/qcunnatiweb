...
public function item_wise_product_sold() {
        ...
        public function download_dscl_Item_Wise_Product_Sold_on_date() 
		{
			...
			//echo 'here';
			//exit;
			$asyncOperation=new AsyncOperationSeasionalReport($filter_date,$this,'download_dscl_Item_Wise_Product_Sold_on_date_2');
			$asyncOperation->start();
    
        
    }
	
	public function download_dscl_Item_Wise_Product_Sold_on_date_2($filter_date)
	{
		  
        $model='report/dscl_input_sales';
      ...
      if (file_exists($file)) { 
        ...
        // $this->registry->set('model_' . str_replace('/', '_', $model), new $class($this->registry));echo 'here';
      } else {
         trigger_error('Error: Could not load model ' . $model . '!');
         exit();               
      }
	  $dscl_input_sales=new ModelReportDsclInputSales();
...
echo 'here';
    ...
    $getproducts = $dscl_input_sales->getproducts();
    $get_stores=$dscl_input_sales->getstores($filter_data);
...
class AsyncOperationSeasionalReport extends Thread {
    ...
    public function __construct($filter_date,$class_name,$function_name) {
        ...
        //echo $this->class_name = $class_name;
