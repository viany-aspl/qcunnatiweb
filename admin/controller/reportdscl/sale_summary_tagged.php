...
class ControllerReportdsclSaleSummaryTagged extends Controller {
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			'text' => 'Sale Summary',
			'href' => $this->url->link('reportdscl/sale_summary_tagged', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$pagination->url = $this->url->link('reportdscl/sale_summary_tagged', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('reportdscl/sale_summary_tagged.tpl', $data));
	}
