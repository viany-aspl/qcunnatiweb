...
//end card
			...
			if(($data['user_group']!="Customer_care") && ($data['user_group']!="BCML Reports"))
                                          {
			...
			if ($this->user->hasPermission('access', 'catalog/information')) {		
				...
				$catalog[] = array(
					'name'	   => 'Warehouse',
					'href'     => $this->url->link('warehouse/warehouse', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);					
			}
			...
			if ($catalog) {
				$data['menus'][] = array(
					...
					'children' => $catalog
                        ...
                        //Purchase Request Zonal
                        if ($this->user->hasPermission('access', 'przonal/purchase_order')) {		
				$catalog[] = array(
					'name'	   => 'Purchase Request Zonal',
					'href'     => $this->url->link('przonal/purchase_order', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);					
			}
//			if($user_info['user_group']!='Regional Manager')
...
//                        if ($this->user->hasPermission('access', 'purchase_order_warehouse/purchase_order')) 
//			{
//				
//					$partnerinventory[]= array(
//					
...
//					
//							'href'     => $this->url->link('purchase_order_warehouse/purchase_order', 'token=' . $this->session->data['token'], true),
//					
//							'children' => array()		
//				
//							);	
//			
                         ...
                         if ($this->user->hasPermission('access', 'przonal/purchase_order')) 
			{
					...
					$partnerinventory[]= array(
                        ...
                        //approvrd order in warehouse 
                         if ($this->user->hasPermission('access', 'pr_approve/purchase_order')) 
			{
					...
					$partnerinventory[]= array(
							...
							'href'     => $this->url->link('pr_approve/purchase_order', 'token=' . $this->session->data['token'], true),
...
//			}        
			...
			if ($procurementinventory) 
			{
					...
					$data['menus'][] = array(
							...
							'name'	   => 'Procurement (purchase request zonal)',
 ...
 //dscl report
		 ...
		 if ($this->user->hasPermission('access', 'reportdscl/sale_summary')) {
			...
			*/
				...
				$report_sale_dscl[] = array(
					'name'	   => 'Reconciliation Report (Subsidy)',
			...
			if ($this->user->hasPermission('access', 'reportdscl/inventory_report')) {
				$inv_report_dscl[] = array(
					...
					'children' => array()
                        ...
                        if ($this->user->hasPermission('access', 'reportdscl/inventory_report')) {
				$inv_report_dscl[] = array(
					'name'	   => 'Purchase Request Process',
					'href'     => $this->url->link('material_request/purchase_order', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			if ($inv_report_dscl) {	
