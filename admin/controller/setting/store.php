...
class ControllerSettingStore extends Controller {
	...
	protected function getList() {
		...
		if (isset($this->request->get['filter_unit'])) 
		{
			...
			$data['filter_unit']=$this->request->get['filter_unit'];
		}
	...
	public function download_licence()
	{
	...
	$data['config_name'] = $store_info['config_name'];
	$data['config_id'] = $store_info['config_name'];
	foreach($store_types as $store_type)
	{
		if($store_type['sid']==$store_info['config_storetype'])
		{
			$data['config_storetype'] = $store_type['type_name'];
		}
	}
    ...
    {         
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $row, $store_info['config_name']);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1, $row, $data["store_id"]);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $row, $config_storetype);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $store_info['config_owner']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $store_info['config_gstn']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $store_info['config_MSMFID']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $row, $store_info['config_Aadhar_ID_number']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $row, $store_info['config_PAN_ID_number']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $row, $store_info['config_fertilizer_number']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, $row, $store_info['config_fertilizer_from']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $row, $store_info['config_fertilizer_to']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, $row, $store_info['config_Pesticide_number']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, $row, $store_info['config_Pesticide_from']);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13, $row, $store_info['config_Pesticide_to']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14, $row, $store_info['config_Seed_number']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15, $row, $store_info['config_Seed_from']);
		$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(16, $row, $store_info['config_Seed_to']);
        $row++;
    }
    ...
    header('Content-Disposition: attachment;filename="Store-License-'.date('dMy').'.xls"');
