...
*/
		...
		if($getdata["user_group_id"]==22)
		{
			$data["cash"]=$getdata["runner_cash"];
		}
               ...
               // $data["card"]=$getdata["card"];
                 ...
                 $data["lastname"]=$getdata["lastname"];
                 $data["storename"]=$getdata["storename"]; 
				 $data["user_group_id"]=$getdata["user_group_id"];
              //exit;
...
if($result['user_group_id']==22)
{
	
	$result['lastname']=$result['lastname'].' - RUNNER';
}
$result['user_id']=$result['user_id'].'--'.$result['user_group_id'];
