<?php
class ControllerCatalogStorecredit extends Controller {
private static function compare_tax_rates ($a, $b) {
	...
	public function edit() {
		...
		$this->load->model('catalog/storecredit');
                //&& $this->validateForm()
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') ) {
			...
			$this->model_catalog_storecredit->editProduct($this->request->get['product_id'], $this->request->post);
...
$data['config_tax_included'] = $this->config->get('config_tax_included');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['product_id'])) {
			...
			$data['action'] = $this->url->link('catalog/store_credit/edit', 'token=' . $this->session->data['token'] . '&product_id=' . $this->request->get['product_id'] . $url, 'SSL');
		}
...
//$data["product_name"] = $this->model_catalog_product->getProductName($this->request->get['product_id']);
		...
		$this->response->setOutput($this->load->view('catalog/store_credit_form.tpl', $data));
	}
