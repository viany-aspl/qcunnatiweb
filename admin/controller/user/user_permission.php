	...
	protected function getForm() {
		...
		if (isset($this->request->post['permission']['modify'])) {
			...
			$data['modify'] = array();
                ...
                if (isset($this->request->post['permission']['mobile'])) {
			$data['mobile'] = $this->request->post['permission']['mobile'];
		} elseif (isset($user_group_info['permission']['mobile'])) {                          
			$data['mobile'] = $user_group_info['permission']['mobile'];
		} else {
			$data['mobile'] = array();
		}
                
                
                //get all mobile menu permission 
                $this->load->model('catalog/storemenu');
                $data['mpermissions'] = $this->model_catalog_storemenu->getmenu();
                
                foreach ($data['mpermissions'] as $perm){
                    $data['msubpermissions'][$perm['category_id']] = $this->model_catalog_storemenu->getsubmenubymenu($perm['category_id']);
                }
                //echo "<pre>" ;   
               //print_r($perm['category_id']);
