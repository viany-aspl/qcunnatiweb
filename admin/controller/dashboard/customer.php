...
class ControllerDashboardCustomer extends Controller {
	public function index() {
		...
		$today = 0;//$this->model_sale_customer->getTotalCustomers(array('filter_date_added' => date('Y-m-d', strtotime('-1 day'))));

		$yesterday = 0;//$this->model_sale_customer->getTotalCustomers(array('filter_date_added' => date('Y-m-d', strtotime('-2 day'))));
