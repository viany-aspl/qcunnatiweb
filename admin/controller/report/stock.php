...
{
	public function cancel_transit_order()
	{
		...
		if($user_group_id==1)
		{
			$order_data=$this->model_report_stock->cancel_transit_order($order_id,$data['user_id']);
	...
	public function transfer() 
	{
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/stock/transfer', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$order_total = $this->model_report_stock->getTotalOrders($filter_data);

		$results = $this->model_report_stock->getOrders($filter_data);
		...
		$data['tool_tip']=$this->language->get('report/stock/transfer');
		...
		$pagination->url = $this->url->link('report/stock/transfer', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('report/stock_transfer.tpl', $data));
	}
	public function transit() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/stock/transit', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$data['heading_title'] = $this->language->get('heading_title');
		$this->load->language('common/information');
		$data['tool_tip']=$this->language->get('report/stock/transit');
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('report/stock/transit', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('report/stock_transit.tpl', $data));
	}
 ...
 public function download_transit() {
   ...
   public function recived() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('report/stock/recived', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		...
		$data['heading_title'] = $this->language->get('heading_title');
		$this->load->language('common/information');
		$data['tool_tip']=$this->language->get('report/stock/recived');
		...
		$pagination->page = $page;
		$pagination->limit = $this->config->get('config_limit_admin');
		$pagination->url = $this->url->link('report/stock/recived', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
		...
		$data['footer'] = $this->load->controller('common/footer');
                $data['filter_name']= $filter_name;
                $data['filter_name_id']= $filter_name_id;
		$this->response->setOutput($this->load->view('report/stock_recived.tpl', $data));
	}
...
if($data['store_name']!="")
	...
	public function transit_po() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('report/stock/po_transit', 'token=' . $this->session->data['token'] . $url, 'SSL')
        );
        ...
        $order_total = $this->model_report_stock->getTotalOrdersTransit_po($filter_data);

        $results = $this->model_report_stock->getOrdersTransit_po($filter_data);
        ...
        $data['heading_title'] = $this->language->get('heading_title');
        $this->load->language('common/information');
		$data['tool_tip']=$this->language->get('report/stock/transit_po');
        ...
        $pagination->page = $page;
        $pagination->limit = $this->config->get('config_limit_admin');
        $pagination->url = $this->url->link('report/stock/transit_po', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $data['footer'] = $this->load->controller('common/footer');
                $data['filter_name']= $filter_name;
                $data['filter_name_id']= $filter_name_id;
        $this->response->setOutput($this->load->view('report/po_transit.tpl', $data));
    }
