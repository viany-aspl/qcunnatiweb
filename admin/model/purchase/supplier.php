...
$log->write("INSERT INTO oc_po_supplier (first_name,last_name,email,telephone,fax,supplier_group_id,date_added,ACC_ID,IFSC_CODE,BANK_NAME,ADDRESS) VALUES('".$data['first_name']."','".$data['last_name']."','".$data['email']."','".$data['telephone']."','".$data['fax']."',".$data['supplier_group_id'].",'".$date_added."','".$data['account']."','".$data['ifsc']."','".$data['bank']."','".$data['address']."')");
	...
	*/
	public function insert_supplier($data)
	{
		$date_added = date('Y-m-d');
$log=new Log("supp.log");
$log->write("INSERT INTO oc_po_supplier (first_name,last_name,email,telephone,fax,supplier_group_id,date_added,ACC_ID,IFSC_CODE,BANK_NAME,ADDRESS,gst,pan,location,status,BANK_ADDRESS) VALUES('".$data['first_name']."','".$data['last_name']."','".$data['email']."','".$data['telephone']."','".$data['fax']."',".$data['supplier_group_id'].",'".$date_added."','".$data['account']."','".$data['ifsc']."','".$data['bank']."','".$data['address']."','".$data['gst']."','".$data['pan']."','".$data['location']."','".$data['status']."','".$data['bankaddress']."')");
		$query = $this->db->query("INSERT INTO oc_po_supplier (first_name,last_name,email,telephone,fax,supplier_group_id,date_added,ACC_ID,IFSC_CODE,BANK_NAME,ADDRESS,gst,pan,location,status,BANK_ADDRESS) VALUES('".$data['first_name']."','".$data['last_name']."','".$data['email']."','".$data['telephone']."','".$data['fax']."',".$data['supplier_group_id'].",'".$date_added."','".$data['account']."','".$data['ifsc']."','".$data['bank']."','".$data['address']."','".$data['gst']."','".$data['pan']."','".$data['location']."','".$data['status']."','".$data['bankaddress']."')");
		if($query)
		{
			return true;
	...
	*/
	...
	public function update_supplier($update_info)
	{
	    ...
	    $sql="UPDATE oc_po_supplier	SET first_name ='".$update_info['first_name']."', last_name = '".$update_info['last_name']."', email = '".$update_info['email']."', telephone = '".$update_info['telephone']."', fax = '".$update_info['fax']."', ACC_ID='".$update_info['ACC_ID']."',IFSC_CODE='".$update_info['IFSC_CODE']."',BANK_NAME='".$update_info['BANK_NAME']."',ADDRESS='".$update_info['ADDRESS']."',gst='".$update_info['gst']."',pan='".$update_info['pan']."',location='".$update_info['location']."',supplier_group_id = ".$update_info['supplier_group_id'].",status = ".$update_info['status']." WHERE id = ".$update_info['supplier_id'];
		//echo $sql;
		//exit;
		$query = $this->db->query($sql);
		if($query)
