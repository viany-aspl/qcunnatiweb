...
else
{
  return "0";
	...
	public function addCustomer($data) {
             $log=new Log("addcust-".date('Y-m-d').".log");
$sql="INSERT INTO " . DB_PREFIX . "customer SET customer_group_id = '" . (int)$data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = '" . $this->db->escape(isset($data['custom_field']) ? serialize($data['custom_field']) : '') . "', newsletter = '" . (int)$data['newsletter'] . "', salt = '" . $this->db->escape($salt = substr(md5(uniqid(rand(), true)), 0, 9)) . "', password = '" . $this->db->escape(sha1($salt . sha1($salt . sha1($data['password'])))) . "', status = '" . (int)$data['status'] . "', approved = '" . (int)$data['approved'] . "', safe = '" . (int)$data['safe'] . "',store_id='".$this->db->escape(isset($data['store_id'])?$data['store_id']:'0')."',card='".$this->db->escape(isset($data['card'])?$data['card']:'0')."', date_added = NOW(),addedby='".$this->db->escape($data['username'])."',aadhar='".$this->db->escape($data['aadhar'])."',otp='".$this->db->escape($data['otp'])."',scheme='".$this->db->escape($data['scheme'])."' ";
...
public function addCustomer_by_mobile($data) {
		...
		$sql="INSERT INTO " . DB_PREFIX . "customer SET customer_group_id = '" . (int)$data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = 'app', newsletter = '" . (int)$data['newsletter'] . "', salt = '" . $this->db->escape($salt = substr(md5(uniqid(rand(), true)), 0, 9)) . "', password = '" . $this->db->escape(sha1($salt . sha1($salt . sha1($data['password'])))) . "', status = '" . (int)$data['status'] . "', approved = '" . (int)$data['approved'] . "', safe = '" . (int)$data['safe'] . "',store_id='".$this->db->escape(isset($data['store_id'])?$data['store_id']:'0')."',card='".$this->db->escape(isset($data['card'])?$data['card']:'0')."', date_added = NOW(),lattitude=". $this->db->escape($data['lattitude']) .",longtitude=". $this->db->escape($data['longtitude']).",imei=". $this->db->escape($data['imei']);
...
public function addCustomer_by_call($data) {
		...
		$sql="INSERT INTO " . DB_PREFIX . "customer SET customer_group_id = '" . (int)$data['customer_group_id'] . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', email = '" . $this->db->escape($data['email']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "', custom_field = 'missed', newsletter = '" . (int)$data['newsletter'] . "', salt = '" . $this->db->escape($salt = substr(md5(uniqid(rand(), true)), 0, 9)) . "', password = '" . $this->db->escape(sha1($salt . sha1($salt . sha1($data['password'])))) . "', status = '" . (int)$data['status'] . "', approved = '" . (int)$data['approved'] . "', safe = '" . (int)$data['safe'] . "',store_id='".$this->db->escape(isset($data['store_id'])?$data['store_id']:'0')."',card='".$this->db->escape(isset($data['card'])?$data['card']:'0')."', date_added = NOW(),lattitude=". $this->db->escape($data['lattitude']) .",longtitude=". $this->db->escape($data['longtitude']);
...
public function getCustomerByEmailCall($email) {
                            $log=new Log("addcust-".date('Y-m-d').".log");
	...
	public function getTotalCustomers($data = array()) {
		...
		if (!empty($data['filter_date_start'])) {
			$implode[]= "  (date_added) >= CAST('" . $this->db->escape($data['filter_date_start']) . "' as DATETIME)";
		}
		if (!empty($data['filter_date_end'])) {
			$implode[]= "  (date_added) <= CAST('" . $this->db->escape($data['filter_date_end']) . "' as DATETIME)";
		}
