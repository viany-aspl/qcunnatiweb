...
';
	...
	function PrintLabel() {
		 ...
		 var pr1 = window.open( "", "PrintLabel");
	       var myhtml = '<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01//EN" "http://www.w3.org/TR/html4/strict.dtd"><html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><link rel="stylesheet" href="css/reset.css" type="text/css"><link rel="stylesheet" href="css/labelgrid.css" type="text/css"></head><body></body></html>';
		 ...
		 labelbody.append('<p style="page-break-before: always;height:1px"></p>');
	 	 ...
	 	 var oleft,otop;
		 oleft=$('.labelwrapper',pr1.document).css('margin-left');
		 otop=$('.labelwrapper',pr1.document).css('margin-top');
		 oleft=ConvertPxToInt(oleft)-21;
		 otop=ConvertPxToInt(otop)-14;
		 oleft=oleft+'px';
		 otop=otop+'px';
		 $('.labelwrapper',pr1.document).css('margin-left',oleft).css('margin-top',otop);

 		 $('.label').children().each(function(index){
			var textobj=$('<div class="label-text ui-widget-content">hello</div>',pr1.document);
			textobj.html($(this).html());

			textobj.css('left',$(this).css('left'));
			textobj.css('top',$(this).css('top'));
			textobj.appendTo($('.label',pr1.document));
		 });
