              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($product['product_id'], $selected)) { ?>
					...
					<td class="text-center"><?php echo $product['HSTN']; ?></td>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=catalog/comboproduct&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	var url = 'index.php?route=catalog/comboproduct/download_excel&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/comboproduct/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'filter_model\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/comboproduct/autocomplete&token=<?php echo $token; ?>&filter_model=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
