...
<div id="content">
  ...
  <div class="container-fluid">
   ...
   <?php  }  ?>
                      ...
                      <td class="text-left">
                        <input type="text" onkeypress="return isNumber(event)"  onkeyup="updatePriceStore(this.value,this.id)" onpaste="updatePriceStore(this.value,this.id)" onchange="updatePriceStore(this.value,this.id)" name="qquantitystoreprice<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" value="<?php if(($store_quantity['store_price']+$store_quantity['store_tax_amt'])!=0){ echo (number_format((float)($store_quantity['store_price']+$store_quantity['store_tax_amt']), 2, '.', '')); } else { echo "0"; } //echo isset($store_quantity['store_price'])?($store_quantity['store_price']+$store_quantity['store_tax_amt']):0 ; ?>" placeholder="<?php echo $entry_price; ?>" id="iinput-quantitystoreprice<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:1 ; ?>" class="form-control" />                                
                         
                      </td>
                      <td class="text-left" style="min-width: 90px;">
                          <input type="text" readonly name="quantitystoreprice<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" value="<?php echo isset($store_quantity['store_price'])? (number_format((float)($store_quantity['store_price']), 2, '.', '')):0 ; ?>" placeholder="<?php echo $entry_price; ?>" id="input-quantitystoreprice<?php echo isset($store_quantity['store_id'])?$store_quantity['store_id']:0 ; ?>" class="form-control" />                              
                      </td>
                      <?php  }  ?>
                       <?php      } if(!$chkpr) {  ?>
                      <td class="text-left">
                          <input type="text" onkeypress="return isNumber(event)" onkeyup="updatePriceStore(this.value,this.id)" onpaste="updatePriceStore(this.value,this.id)" onchange="updatePriceStore(this.value,this.id)" name="qquantitystoreprice<?php echo $store['store_id']; ?>" value="<?php if(($store_quantity['store_price']+$store_quantity['store_tax_amt'])!=0){ echo (number_format((float)($store_quantity['store_price']+$store_quantity['store_tax_amt']), 2, '.', '')); } else { echo "0"; } //echo isset($store_quantity['store_price'])?$store_quantity['store_price']:0 ; ?>" placeholder="<?php echo $entry_price; ?>" id="iinput-quantitystoreprice<?php echo $store['store_id']; ?>" class="form-control" />                              
                      </td>
                      <td class="text-left" style="min-width: 90px;">
