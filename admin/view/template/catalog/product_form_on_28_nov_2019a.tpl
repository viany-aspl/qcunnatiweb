...
<div id="content">
  ...
  <div class="container-fluid">
	...
	<?php //print_r($hsn_codes); ?> 
	     <select name="hstn" id="input-hstn" class="form-control" >
	    ...
	    <?php if ($error_hstn) { ?>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-isbn"><span data-toggle="tooltip" title="<?php echo "Pack Size"; ?>"><?php echo "Pack Size"; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="isbn" value="<?php echo $isbn; ?>" placeholder="<?php echo "Pack Size"; ?>" id="input-isbn" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-mpn"><span data-toggle="tooltip" title="<?php echo "Multiple Factor"; ?>"><?php echo "Multiple Factor"; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="mpn" value="<?php echo $mpn; ?>" placeholder="<?php echo "Multiple Factor" ?>" id="input-mpn" class="form-control" />
                </div>
              </div>
              <div class="form-group">
