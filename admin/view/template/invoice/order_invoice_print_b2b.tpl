...
<body >
    <div class="container top_mar20" style="width: 89%;font-size:90%;">
        <div class="row">
            <div class="col-sm-12">
...
<tr>
                        ...
                        <td colspan="7" style="text-align: right;">
                            <!--<p>-This will be cumulative sum of Tax added on all products for this category</p>
                            <p>-Only that tax will be displayed that is added included in the invoice</p>
                            --><span class="pull-right">CGST @9%  : <?php echo number_format((float)$total_gst_28, 2, '.', ''); ?></span><br />
                            <span class="pull-right">SGST @9% : <?php echo number_format((float)$total_gst_28, 2, '.', ''); ?></span>
                        </td> 
                  <?php } ?>  
                      </tr>
<tr>
					  <td colspan="7" style="text-align: right;padding: 10px;">
                       ...
                       <tr>
                           <td colspan="7" style="font-size:90%;">
                               <small>
                       ...
                       <tr>
						  ...
						  <br/><br/>
                           ...
                           <td style="font-size:90%;padding-bottom: 30px;"> <small style="font-size:90%;">Authorised Signatory</small>
                          <br/>
                           </td>
                       </tr>
                  </table>
