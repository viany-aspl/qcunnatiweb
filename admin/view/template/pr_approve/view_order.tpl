...
function confirm_order(order_id)
{
    ...
    alertify.confirm('Are you sure ! you want to approve this order ?',
                function(e){ 
                    if(e){
        url = 'index.php?route=przonal/rm/confirm_order_by_rm&token=<?php echo $token; ?>';
...
function confirm_order_by_cm(order_id)
{
    ...
    alertify.confirm('Are you sure ! you want to approve this order ?',
                function(e){ 
                    if(e){
        url = 'index.php?route=przonal/cm/confirm_order_by_cm&token=<?php echo $token; ?>&order_total='+order_total+'&creditlimit='+creditlimit+'&currentcredit='+currentcredit;
...
function canceled_by_rm_with_msg(order_id)
{
    ...
    url = 'index.php?route=przonal/rm/cancel_order_by_rm&token=<?php echo $token; ?>';
...
function canceled_by_cm_with_msg(order_id)
{
    ...
    url = 'index.php?route=przonal/cm/cancel_order_by_cm&token=<?php echo $token; ?>';
...
function canceled_by_account_with_msg(order_id)
{
    ...
    url = 'index.php?route=przonal/account/cancel_order_by_account&token=<?php echo $token; ?>';
