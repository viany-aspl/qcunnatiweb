...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1><?php echo "PR Approve"; ?></h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php // echo $breadcrumb['href']; ?>">PR Approve</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> <?php echo "Purchase Request Approve"; ?></h3>
...
<!--                                                            <a class="btn btn-info" href="<?php echo $view . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="view" class="btn btn-primary">
							...
							<a href="<?php echo $receive . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="<?php echo "Confirm Dispatch"; ?>" style="margin-left: 5px;" class="btn btn-info">
                                                            <i class="fa fa-truck"></i>
                                                        </a>
                                                        <?php } ?>
                                                            
                                                            <?php if($order['order_sup_send']=='0000-00-00'){ ?>
<!--                                                            <a href="#" data-toggle="tooltip" onclick="return confirm_purchase('<?php echo $order['id'];?>')" id="confirm_purchase" title="<?php echo "Confirm Purchase"; ?>" style="margin-left: 5px;" class="btn btn-success">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=pr_approve/purchase_order&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=pr_approve/purchase_order/download_excel&token=<?php echo $token; ?>';
  ...
  <script type="text/javascript">
	...
	{   
        ...
        function confirm_purchase(order) {
          ...
          {                        
            ...
            $.ajax({ 
            type: 'post',
            url: 'index.php?route=purchase/purchase_order/update_order&token=<?php echo $token;?>',
            data: {order_id:order},
            cache: false,
