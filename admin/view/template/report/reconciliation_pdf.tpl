...
Letter No. - ASPL-<?php echo $file_aspl; ?>
	...
	<th  class="text-right">Inv no.</th>
            ...
            <tbody style="font-size: 10px !important;">
              ...
              <tr >
                <td class="text-left" style="font-size: 10px;"><?php echo $aa; ?></td>
                <td class="text-left" style="font-size: 10px;"><?php echo $order['unit']; ?></td>
                <td class="text-right" style="font-size: 10px;"><?php echo $order['store_name']; ?></td>
                <!--<td class="text-right"><?php echo $order['store_id']; ?></td>-->
                <td class="text-right" style="font-size: 10px;"><?php echo $order['order_id']; ?></td>
	<td class="text-right" style="font-size: 10px;"><?php echo $order['inv_no']; ?></td>
                <td class="text-right" style="font-size: 10px;"><?php echo $order['grower_id']; ?></td>
                <td class="text-leftt" style="font-size: 10px;"><?php echo $order['farmer_name']; ?></td>
		...
		<?php } ?>
                ...
                <td class="text-right" style="font-size: 10px;"><?php echo $order['date']; ?></td>
                <!--<td class="text-right"><?php echo $order['total']; ?></td>-->
                <td class="text-right" style="font-size: 10px;"><?php echo number_format((float)$order['tagged'], 2, '.', ''); ?></td>
