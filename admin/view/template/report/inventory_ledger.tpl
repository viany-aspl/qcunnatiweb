  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
		...
		<button type="button" id="button-download" class="btn btn-primary pull-right" style="margin-top: -10px;"><i class="fa fa-download"></i>Download Excel</button>
      </div>
	...
	<td class="text-right">CURRENT INVENTORY</td>
				...
				<td class="text-right">Sale By</td>
				<td class="text-right">System</td>
              </tr>
            </thead>
            <tbody>
              <?php if ($products) { ?>
		...
		<td class="text-right"><?php echo $product['sale_by']; ?></td>
		<td class="text-right"><?php echo $product['billing_type']; ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
              <tr>
...
$('#button-download').on('click', function() {
	url = 'index.php?route=report/inventory_ledger/download_excel&token=<?php echo $token; ?>';
