            ...
            <tbody>
              ...
              <tr>
               ...
               <!-- <td class="text-left"><?php echo $order['No_of_orders']; ?></td>-->
                ...
                <td class="text-left"><?php echo number_format((float)($order['p_price']), 2, '.', ''); ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/aspl_sales&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=report/aspl_sales/download_excel&token=<?php echo $token; ?>';
