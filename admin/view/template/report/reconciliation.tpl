...
<i class="<?php echo $tool_tip_class; ?> " data-toggle="tooltip" style="<?php echo $tool_tip_style; ?>" title="<?php echo $tool_tip; ?>"></i>
  ...
  <div class="container-fluid">
	...
	<td class="text-right"><?php echo $order['inv_no']; ?></td>
                ...
                <td class="text-right"><?php echo number_format((float)$order['tagged'], 2, '.', '');//$this->currency->format(number_format((float)$order['tagged'], 2, '.', ''), $this->config->get('config_currency')) ; ?></td>
              </tr>              <?php $aa++; } ?>
              <?php  } else { ?>
              <tr>
