...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/cash_report/cash_position&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    ...
    url = 'index.php?route=report/cash_report/download_cash_position_excel&token=<?php echo $token; ?>';
