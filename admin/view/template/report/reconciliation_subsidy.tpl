...
<td class="text-right"><?php echo $order['Ref_no']; ?></td>
  ...
  <div class="modal fade" id="myModal_create_bill" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="index.php?route=report/reconciliationsubsidy/create_bill&token=<?php echo $token; ?>" method="post" enctype="multipart/form-data" onsubmit="return myFunction()" >
            <div class="form-group">
	...
	<div class="form-group">
                ...
                <div class="input-group date" id="date_cr">
                  <input required type="text" name="filter_date22"  placeholder="" data-date-format="YYYY-MM-DD" id="input-date22" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span></div>
              </div>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/reconciliationsubsidy&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=report/reconciliationsubsidy/download_excel&token=<?php echo $token; ?>';
...
$('#button-pdf').on('click', function() {
	url = 'index.php?route=report/reconciliationsubsidy/download_pdf&token=<?php echo $token; ?>';
...
$('#button-details').on('click', function() {
	url = 'index.php?route=report/reconciliationsubsidy/download_item_excel&token=<?php echo $token; ?>';
