...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1><?php echo "Sub User Material Summary"; ?></h1>
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo "Sub User Material Summary"; ?>"><?php "Material Summary"; ?></a></li>
        <?php } ?>
      </ul>
  ...
  <div class="container-fluid">
    <div class="panel panel-default">
      <div class="panel-heading">
		...
		<button type="button" id="downloadall" class="btn btn-primary pull-right" style="margin-top: -8px !important; ">
            Download All</button>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/subuser&token=<?php echo $token; ?>';
    ...
    //if((filter_user=="") && (filter_store=="") && (filter_name_id==""))
	//{
	//alertify.error("Please Select Store OR User OR Product");
	//return false;
	//}
...
$('#button-download').on('click', function() {
    url = 'index.php?route=report/subuser/download_excel_material_summary&token=<?php echo $token; ?>';
   // alert(url);
    var filter_user = $('#filter_user').val();
	var filter_name_id = $('input[name=\'filter_name_id\']').val();
    var filter_name = $('input[name=\'filter_name\']').val();
...
$('#downloadall').on('click', function() {//alert("bsahbf");
    url = 'index.php?route=report/subuser/download_excel_material_summaryAll&token=<?php echo $token; ?>';
