...
<i class="<?php echo $tool_tip_class; ?> " data-toggle="tooltip" style="<?php echo $tool_tip_style; ?>" title="<?php echo $tool_tip; ?>"></i>
  ...
  <div class="container-fluid">
	...
	<div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                <label class="control-label" >Select CE</label>
                  ...
                  <select name="filter_user" id="filter_user" class="form-control" style="width: 100%;">
	...
	<?php } ?>
		...
		<option value="0" <?php if($filter_status=='0'){ ?> selected="selected" <?php } ?> >Pending at Runner (Deposit by Store) </option>
		<option value="1" <?php if($filter_status=='1'){ ?> selected="selected" <?php } ?> >Deposit by Runner</option>
		<option value="3" <?php if($filter_status=='3'){ ?> selected="selected" <?php } ?> >Accepted</option>
	...
	<span style="font-weight: bold;"> Sales Adjustment : <?php echo $Sales_Adjustment; ?></span>
              <br/><br/>
	...
	<td class="text-right">Accept By </td>
              </tr>
            </thead>
            <tbody>
	...
	<td class="text-right">
		...
		if($order['status']=="0") 
		{ 
			//echo "<spna style='color: orange;'>Pending at Runner</span>"; 
		} 

		else if($order['status']=="1") 
		{ 
			//echo "<spna style='color: #4F5F07;'>Deposit by Runner</span>"; 
		...
		*/
		//echo    $order['accepted_by'];
		if($order['accepted_by']==' ') 
		{ 
			if($order['bank_name']=='Sales Adjustment')
			{
