...
<i class="<?php echo $tool_tip_class; ?> " data-toggle="tooltip" style="<?php echo $tool_tip_style; ?>" title="<?php echo $tool_tip; ?>"></i>
  ...
  <div class="container-fluid">
	...
	<td class="text-left">Order ID</td>
            ...
            <tbody>
              <?php if ($orders) { $total_amount=0;$total_quantity=0; ?>
	...
	<td class="text-left"><?php echo $order['order_id']; ?></td>
			  ...
			  <?php
$total_amount=$total_amount+($quantity*$order['total']);
//echo "<br/>";
$total_quantity=$total_quantity+($order['received_products']);
			  } ?>
              <?php } else { ?>
              <tr>
        ...
        <div class="row">
		  ...
		  <?php echo $results; ?>
		  <span><br/><b>Page Total :: </b>
			<br>
			<b>Total Amount : </b> <?php echo $total_amount; ?> &nbsp; || &nbsp; <b>Total Quantity : </b> <?php echo $total_quantity; ?>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/stock/recived&token=<?php echo $token; ?>';
