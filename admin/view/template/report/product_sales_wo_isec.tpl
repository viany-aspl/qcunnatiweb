...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/product_sales/wo_isec&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=report/product_sales/download_excel_wo_isec&token=<?php echo $token; ?>';
