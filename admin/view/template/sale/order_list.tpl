		 ...
		 <td class="text-left">OP Name</td>
              ...
              <tbody>
                ...
                <tr>
				  ...
				  <td class="text-left"><?php echo $order['subsidy_coupon']; ?></td>
	    <td class="text-left"><?php echo $order['req_id']; ?></td>
	    <td class="text-left"><?php echo $order['payment_method']; ?></td>
		<td class="text-left"><?php echo $order['op_name']; ?></td>
...
$('#button-details').on('click', function() {
	url = 'index.php?route=sale/order/download_item_excel&token=<?php echo $token; ?>';
...
$('#button-orders').on('click', function() {
	url = 'index.php?route=sale/order/download_order_excel&token=<?php echo $token; ?>';
