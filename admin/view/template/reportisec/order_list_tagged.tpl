            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a href="<?php echo $order['invoice']; ?>" style="margin-top: 2px;" target="_blank" data-toggle="tooltip" title="Download Invoice" class="btn btn-info"><i class="fa fa-download"></i></a> 
                  <?php } else { ?>   
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportisec/order_tagged&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportisec/order_tagged/download_excel&token=<?php echo $token; ?>';
