...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportisec/debitstore/getWaveoffdata&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportisec/debitstore/getWaveoffdata_download&token=<?php echo $token; ?>';
