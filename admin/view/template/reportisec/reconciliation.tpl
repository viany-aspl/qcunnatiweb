...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportisec/reconciliation&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportisec/reconciliation/download_excel&token=<?php echo $token; ?>';
...
$('#button-details').on('click', function() {
	url = 'index.php?route=reportisec/reconciliation/download_item_excel&token=<?php echo $token; ?>';
