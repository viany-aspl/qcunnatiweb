...
$('#button-filter').on('click', function() {
	 url = 'index.php?route=reportisec/productreconciliation&token=<?php echo $token; ?>';
	 //url += '&page='+'1';
         //url += '&tab='+'1';
...
<script type="text/javascript">
	...
	url = 'index.php?route=reportisec/productreconciliation/download_recived&token=<?php echo $token; ?>';
...
<script type="text/javascript">
	...
	url = 'index.php?route=reportisec/productreconciliation/download_sold&token=<?php echo $token; ?>';
