	 ...
	 <button type="button" id="button-download" class="btn btn-primary pull-right" <?php if($filter_stores_id=="") { ?>style="margin-top: -8px;display: none;" <?php } else { ?> style="margin-top: -8px;"  <?php } ?>> Download</button>
      ...
      <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select name="filter_stores_id" id="input-status" class="select2 form-control" onchange="return show_download(this.value);">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-right"> DEPOSIT / CREDIT NOTE / WAIVER / MATERIAL RECEIVED</td>
		...
		?>
                ...
                <td class="text-right"><?php echo $product['Deposite']; ?></td>
                <td class="text-right"><?php echo $product['Withdrawals']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportisec/leadger&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportisec/leadger/download_pdf&token=<?php echo $token; ?>';
