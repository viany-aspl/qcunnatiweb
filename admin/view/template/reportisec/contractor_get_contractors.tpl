...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/contractor_report/get_contractors&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=report/contractor_report/get_contractors_download_excel&token=<?php echo $token; ?>';
