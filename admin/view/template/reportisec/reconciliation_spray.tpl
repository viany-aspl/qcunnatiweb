...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportisec/reconciliationspray&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportisec/reconciliationspray/download_excel&token=<?php echo $token; ?>';
...
$('#button-pdf').on('click', function() {
	url = 'index.php?route=reportisec/reconciliation/download_pdf&token=<?php echo $token; ?>';
...
$('#button-details').on('click', function() {
	url = 'index.php?route=reportisec/reconciliationspray/download_item_excel&token=<?php echo $token; ?>';
