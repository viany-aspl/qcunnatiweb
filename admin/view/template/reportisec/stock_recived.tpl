            ...
            <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-date-end">Select Store (Receiver)</label>
                  ...
                  <select name="filter_store" id="input-store" class="form-control select2" style="width: 100%">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportisec/stock/recived&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportisec/stock/download_recived&token=<?php echo $token; ?>';
