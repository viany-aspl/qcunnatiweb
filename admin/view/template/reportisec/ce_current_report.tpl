          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $order['updated_time']; ?></td>
...
$('#button-download').on('click', function() {
    url = 'index.php?route=reportisec/cash_report/download_runner_current_postion_excel&token=<?php echo $token; ?>';
