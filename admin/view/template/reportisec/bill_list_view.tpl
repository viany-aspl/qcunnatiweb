...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportisec/billsubmission/getlist&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportisec/billsubmission/getlist_download&token=<?php echo $token; ?>';
