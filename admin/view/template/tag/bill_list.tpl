    ...
    <div class="panel panel-default">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <select required name="filter_unit"  id="filter_unit" style="width: 100%;" class="select2 form-control" >
                      <option selected="selected" value="">SELECT UNIT</option>
                  <?php foreach ($units as $store) {   ?>
                  <?php if ($store['unit_id'] == $filter_unit) {
                      if($filter_unit!=""){
                      ?>
                  <option value="<?php echo $store['unit_id']; ?>" selected="selected"><?php echo $store['unit_name']; ?></option>
                      <?php }} else { ?>
                  <option value="<?php echo $store['unit_id']; ?>"><?php echo $store['unit_name']; ?></option>
                  <?php } ?>
                  <?php } ?>
                </select>
              </div>
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-date-modified">Bill date</label>
                <div class="input-group date">
	 ...
	 <td class="text-left">Submitted by</td>
	  ...
	  <td class="text-left"><?php echo $bill['submitted_by']; ?></td>
                  ...
                  <td class="text-left"><?php if($bill['uploded_file']!=""){ ?><a href="../system/upload/tagslips/<?php echo $bill['uploded_file']; ?>" download>View</a><?php } ?></td>
                  <td class="text-left"><?php echo $bill['tagged_letter_number']; ?></td>
                  <td class="text-left"><?php if($bill['payment_status']=="1"){echo "Pending";} else if($bill['payment_status']=="3") { echo "Accepted"; } else if($bill['payment_status']=="2") { echo "Rejected"; } ?></td>
