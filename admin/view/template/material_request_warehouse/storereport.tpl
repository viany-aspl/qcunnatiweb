...
<ul id="geo" class="nav nav-tabs nav-justified">
            <li class="<?php echo $tab1; ?>"><a onclick="return active_tab(1); " href="#tab-nation" data-toggle="tab">Approved PR</a></li>
            <li class="<?php echo $tab2; ?>"><a onclick="return active_tab(2); " href="#tab-zone" data-toggle="tab">PR in Transit</a></li>
            <li class="<?php echo $tab3; ?>"><a onclick="return active_tab(3); " href="#tab-region" data-toggle="tab">Dispatch</a></li>
