		  ...
		  ?>
            <tr>
			  ...
			  <td class="text-left" style="width: 20%;">
                                <?php echo $order_information['order_info']['po_number']!=''?"PO No: ".$order_information['order_info']['po_number']:'';?>
                              <select class="form-control" id="ware_house_<?php echo $a; ?>" name="ware_houses[]">
                                    <option value="">SELECT SUPPLIER</option>
                                    <?php foreach($suppliers as $supplier){ ?>
                                    <option value="<?php echo $supplier['id']; ?>" <?php echo $product['supplier_id']==$supplier['id']?'selected="selected"':'';?> ><?php echo $supplier['first_name']." ".$supplier['last_name']; ?></option>
				<?php } ?>
				</select>
