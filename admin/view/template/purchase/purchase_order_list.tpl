...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1><?php echo "Unnati Krishi Kendra Requisition"; ?></h1>
      <ul class="breadcrumb">
              ...
              <thead>
                <tr>
				  ...
				  <td class="text-left">Ordered By</td>
                                    <td class="text-left">PO Number/Supplier/Ware House / OTP</td>
              ...
              <tbody>
				...
				?>
						<tr>
							...
							<?php if($user_group_id!='27'){ ?>
							<td class="text-left">
                                                            <a class="btn btn-info" data-target="#view_image" href="#" data-id="<?php echo $order['id'];?>" data-toggle="modal" data-title="Linked PO Image(<?php echo $order['po_number'];?>)" title="PO Image" class="btn btn-primary">
...
<script>
    jQuery('#view_image').on('show.bs.modal', function (e) {
        ...
        var url = 'index.php?route=purchase/purchase_order/dispaly_image&token=<?php echo $token; ?>';
