...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/ce&token=<?php echo $token; ?>';
...
$('#button-download1').on('click', function() {
    url = 'index.php?route=report/ce/download_excel&token=<?php echo $token; ?>';
...
$('#button-download2').on('click', function() {
    url = 'index.php?route=report/ce/download_excel_runner&token=<?php echo $token; ?>';
