...
<br/>
		...
		<a class="btn btn-primary pull-right" onclick="return adjust_expense('<?php echo $bill["store_id"]; ?>','<?php echo $bill["amount"]; ?>','<?php echo $bill["expense_balance"]; ?>');" style="margin-top: 5px;width: 71px;" href="#">Adjust</a>
	<?php } ?>
...
<!-- Modal -->
  <div class="modal fade" id="myModal_partner2" role="dialog">
   ...
   alert('kkkk');
   function adjust_expense()
{
amount=parseFloat(amount);
expense_balance=parseFloat(expense_balance);
var url="index.php?route=hr/expenseapp/adjustexpense&token=<?php $token; ?>&store_id="+store_id+"&amount="+amount;
