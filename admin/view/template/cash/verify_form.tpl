  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i> Cash Verify</h3>
      </div>
...
<div class="col-sm-8" style="font-weight: bold;padding-top: 9px;font-size: 18px;" id="for_current_credit" ></div>
           ...
           <div class="form-group required">
            ...
            <div class="col-sm-10">
                ...
                <select required name="filter_trans_type" id="filter_trans_type" class="form-control" >
