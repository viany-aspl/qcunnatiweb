  ...
  <div class="container-fluid">
	...
	<td class="text-left">Transaction Number</td>
	 ...
	 <td class="text-left">Action</td>
            ...
            <tbody>
              <?php if ($orders) { $total=0; if($_GET["page"]=="1"){ $aa=1; }elseif($_GET["page"]==""){$aa=1;} else { $aa=((@$_GET["page"]-1)*20)+1; } ?>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=cash/verify/verify_runner_deposit_mid&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=cash/verify/verify_runner_deposit_download_mid&token=<?php echo $token; ?>';
