    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
	    ...
	    <td class="text-left"><?php echo $bill['amount']; ?></td>
                  ...
                  <td class="text-left"><?php if($bill['status']=="0"){ ?>
                      <a class="btn btn-primary pull-right"  onclick="return regQuery_bill_reject('<?php echo $bill["sid"]; ?>','1');" style="width: 70px;" href="#">Approve</a>
                      <br/>
                      <a class="btn btn-primary pull-right" onclick="return regQuery_bill_reject('<?php echo $bill["sid"]; ?>','2');" style="background-color: #D44F32;margin-top: 5px;width: 70px;" href="#">Reject</a>
                      <?php
                       } ?></td>
                </tr>
                <?php } ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Please enter remarks ? </h4>
        </div>
        <div class="modal-body">
        <form action="index.php?route=expense/expense/accept_reject&token=<?php echo $token; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="input-group"><span class="input-group-addon"><i class="fa fa-envelope"></i></span>
                <textarea name="Message" required id="Message" class="form-control" placeholder="Remarks"></textarea>
            </div>
            </div>
...
function regQuery_bill_reject(sid,status)
{
    $('#sid').val(sid);
    $('#status').val(status);
