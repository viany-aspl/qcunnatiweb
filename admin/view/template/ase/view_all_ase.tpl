  ...
  <div class="container-fluid">
    <div class="panel panel-default">
	  ...
	  <td class="text-left"><?php echo $order['store_name']; ?></td>
                <td class="text-left"><?php if($order['status']=="1"){ echo 'Active';} else { echo 'Deactive'; } ?></td>
...
$('#button-download').on('click', function() {
	url = 'index.php?route=ase/asereports/download_excel_aselist&token=<?php echo $token; ?>';
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=ase/asereports/aselist&token=<?php echo $token; ?>';
