  ...
  <div class="container-fluid">
    <div class="panel panel-default">
	  ...
	  <td class="text-left">Store Name </td>
                ...
                <td class="text-right">Farmer count</td>
	...
	<td class="text-left"><?php echo $order['village_name']; ?></td>
                ...
                <td class="text-right"><?php echo $order['ase_name']; ?></td>
                <td class="text-right"><?php echo $order['visit_date']; ?></td>
                <td class="text-right"><?php echo $order['farmer_count']; ?></td>
                <td class="text-right"><div style="max-width: 200px;"><?php echo $order['remarks']; ?></div></td>
              </tr>
              <?php 
              $aa++;
              } ?>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=ase/asereports/village_visit&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=ase/asereports/village_visit_download&token=<?php echo $token; ?>';
