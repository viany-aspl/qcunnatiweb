              ...
              <tbody>
				...
				?>
						<tr>
							...
							<td class="text-left"><?php if($order['receive_date']=='0000-00-00'){ echo "Pending"; }else if($order['receive_bit']==2){ echo "Rejected"; }else{ echo "Received"; }?></td>
<?php if($user_group_id!='27'){ ?>
							<td class="text-left">
							...
							<a href="<?php echo $receive . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="<?php echo "Confirm Requisition"; ?>" style="margin-left: 5px;" class="btn btn-info">
                                                        ...
                                                        <?php } //echo $order['pre_supplier_bit'];
