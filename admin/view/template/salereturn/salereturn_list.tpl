...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      ...
      <h1><?php echo "Sale Return"; ?></h1>
	  
      <ul class="breadcrumb">
        <?php foreach ($breadcrumbs as $breadcrumb) { ?>
        <li><a href="<?php echo $breadcrumb['href']; ?>">Sale Return</a></li>
        <?php } ?>
      </ul>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i> <?php echo "Sale Return List"; ?></h3>
      ...
      <div class="panel-body">
        ...
        <div class="well">
		  ...
		  <div class="row">
                        <div class="col-sm-6">
              <div class="form-group">
                <label class="control-label" for="input-date-added"><?php echo "Invoice Number (ASPL/BBSR/)"; ?></label>
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <td class="text-left">Amount (with tax)</td>
              ...
              <tbody>
				...
				?>
						<tr>
							...
							<td class="text-left"><?php echo $order['sale_invoice_prefix']."/".$order['sid']; ?></td>
							
							<td class="text-left">
                                <!--<a class="btn btn-info" href="<?php echo $view . '&order_id='.$order['id']; ?>" data-toggle="tooltip" title="view" class="btn btn-primary">
                                <i class="fa fa-eye"></i>
                                </a>-->
								<a href="<?php echo $invoice . '&invoice_id='.$order['sid']; ?>" data-toggle="tooltip" title="<?php echo "Download Sale return"; ?>" style="margin-left: 5px;" class="btn btn-info">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=salereturn/purchase_order&token=<?php echo $token; ?>';
	//alert(url);
...
$('#button-download').on('click', function() {
	url = 'index.php?route=salereturn/purchase_order/download_excel&token=<?php echo $token; ?>';
