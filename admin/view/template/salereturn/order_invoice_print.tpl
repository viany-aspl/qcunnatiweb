        ...
        <div class="row">
            <div class="col-sm-12">
               <div class="table-responsive">
                   <center> <h4 style="text-align: center;">Sale Return</h4></center>
                   <table class="table table-bordered" style="margin-bottom: 0px;">
                    ...
                    <tr>
                        <td style="width: 50%;" class="col-sm-6">
                            ...
                            PAN : <span id="to_store_pan"><?php echo $store_to_data[4];   ?></span> <br />
                            GSTN : <span id="to_store_gstn"><?php  echo $store_to_data[5];   ?></span><br />
                      ...
                      <tr>
                          ...
                          <td style="width: 50%;" class="col-sm-6">
                              ...
                              Invoice Number: <?php echo $order_information['order_info']['sale_invoice_prefix']; ?>/<?php echo $order_information['order_info']['sid'];  ?>
