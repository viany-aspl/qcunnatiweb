...
<div id="content">
  ...
  <div class="panel panel-default" id = "print_div">
	...
	<?php }?>
                        ...
                        <td class="col-sm-6"><strong>To :</strong><br />
...
<!--                            <select onchange="return get_ship_to_data(this.value);" required name="ship_to" id="ship_to" style="float: right;width: 80%;width: 57%;height: 29px;padding: 4px;" class="form-control">
                    ...
                    ?>
                              ...
                              <?php if(empty($created_po)){ ?> 
                              <select required name="ware_house" id="ware_house" onchange="return get_ship_to_data(this.value);" style="float: right;width: 80%;width: 57%;height: 29px;padding: 4px;" class="form-control">
                    <option value="">SELECT</option>
	...
	<?php }?>
                          ...
                          <td>
                              ...
                              Invoice Number: <?php echo $order_information['order_info']['sale_invoice_prefix']; ?>/<?php echo $created_po;  ?>
                          </td>
                      </tr>
                      </table>
		...
		<table class="table table-bordered" id="print_table" border="1">
          <thead>
                <tr>
                          ...
                          <td class="text-left" style="width: 11.11%;">Current Store Inventory</td>
		...
		?>
         ...
         <?php if(empty($created_po)){ ?>
            <input type="button" onclick="return check_ware_house_quantity();" class="btn btn-primary pull-right" id="cr_btn" value="Create Sale Return" />
...
function check_ware_house_quantity()
{
    ...
    var url = 'index.php?route=salereturn/purchase_order/check_ware_house_quantity&token=<?php echo $token; ?>';
...
function get_ship_to_data(store_id)
{
   ...
   if((store_id!="") && (store_id!="0"))
    ...
    else
    {
                ...
                $("#ship_to_phone").html('');
                $("#ship_to_email").html('');
                $("#ship_to_pan").html('');check_ware_house_quantity
                $("#ship_to_gstn").html('');
 ...
 <script type="text/javascript">
   $('input[name=\'product_name[]\']').autocomplete({
    ...
    $("#span_sgst_"+thisid).html(tax_sgst);
        ...
        $('#grand_total').val(grand_total);
        $.ajax({
            url: 'index.php?route=partner/purchase_order/get_current_inventory&token=<?php echo $token; ?>&filter_id=' +  encodeURIComponent(item['value'])+'&filter_ware_house='+($("#store_to").val()),
            dataType: 'json',
            success: function(json) { 
                //alert(json);
                if(json=="")
