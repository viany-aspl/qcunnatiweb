...
<div id="content">
  ...
  <div class="panel panel-default" id = "print_div">
	...
	<div class="panel-body">
               ...
               <div class="table-responsive">
                          ...
                          <td >   
                             ...
                             <label class="control-label" for="input-date-end"><?php echo "Invoice Date"; ?></label>
                              <div class="input-group date">
                                  <input type="text" name="filter_date" autocomplete="off" readonly="readonly"  value="" placeholder="<?php echo "Valid Date"; ?>" data-date-format="YYYY-MM-DD" id="input-date-start" class="form-control" required="required"/>
                  ...
                  <?php } ?>
                             ...
                             <label class="control-label" for="input-date-end">Purchase Request Number</label>
							  ...
							  <div class="col-sm-12">
                              <div class="form-group">
                             <label class="control-label" for="input-date-end">Tax Type</label>
                              <select name="tax_type" onchange="return reset_product(this.value);" id="input-tax_type" class="form-control select2">
		...
		<table class="table table-bordered" id="tax_table1">
          <tbody>
		...
		<table class="table table-bordered" id="tax_table2">
		<input type="hidden" name="igst_type" id="igst_type" />
		<input type="hidden" name="igst_value" id="igst_value" />
          <tbody>
		 
                <tr id="tr_igst" style="display: none;">
                    <td class="text-right" style="width: 78%;"><b>
                            <span id="span_igst_text">
   ...
   //alert(valuee);
    ...
    $("#span_sgst_type_"+thisid).val('CGST @'+sgst+'% '); 
		...
		if(tax_type=='Intra-State')
		{
			...
			if(total_tax_by_5>0)
			{
				$("#span_igst_text").html('IGST @5%');
				$("#igst_type").val('IGST @5%');
				total_igst=parseFloat(total_tax_by_5)*2;
			}
			if(total_tax_by_12>0)
			{
				$("#span_igst_text").html('IGST @12%');
				$("#igst_type").val('IGST @12%');
				total_igst=parseFloat(total_tax_by_12)*2;
			}
			if(total_tax_by_18>0)
			{
				$("#span_igst_text").html('IGST @18%');
				$("#igst_type").val('IGST @18%');
				total_igst=parseFloat(total_tax_by_18)*2;
			}
			if(total_tax_by_28>0)
			{
				$("#span_igst_text").html('IGST @28%');
				$("#igst_type").val('IGST @28%');
				total_igst=parseFloat(total_tax_by_28)*2;
			}
			
			$("#igst_value").val(total_igst);
			$("#span_igst_value").html(total_igst);
			$("#tr_igst").show();
		}
		else
		{
