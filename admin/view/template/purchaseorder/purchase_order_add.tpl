...
<script type="text/javascript">
   ...
   $('input[name=\'contactname\']').autocomplete({
    ...
    'source': function(request, response) {
        $.ajax({
            url: 'index.php?route=purchaseorder/purchase_order/user_autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request)+'&store_id=' +  encodeURIComponent($("#input-store").val()),
            dataType: 'json',
            success: function(json) { 
