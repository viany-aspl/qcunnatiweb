...
<div id="content">
    ...
    <div class="container-fluid">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['href']; ?>"><?php echo "Credit Note"; ?></a></li>
        <?php } ?>
      </ul>
  ...
  <div class="panel panel-default" id = "print_div">
	<div class="panel-heading">
      ...
      <form method="post" action="" id="credit_form">
	<div class="panel-body">
                  ...
                  <table class="table table-bordered">
                    <tr>
                      ...
                      <tr>
                          <td class="col-sm-6">
                              <strong>Store: </strong>
                              <select onchange="return get_ship_to_data(this.value);" name="filter_store" id="input-store" required="required" class="form-control">
            ...
            <tr id="tr_<?php echo  $a; ?>">
                ...
                <td class="text-left" id="td_sid_<?php echo  $a; ?>"><?php echo  $a;?></td>
                          ...
                          <td class="text-left" id="td_p_inventory_<?php echo  $a; ?>">
                               <input required="required" type="text" class="form-control" name="activity[]" />
                           </td>
			  <td class="text-left" id="td_p_price_<?php echo  $a; ?>">
		 <?php if(empty($created_po)){ ?> 
                              <input required="required"  class="form-control"  onkeypress="return remove_zero(this.value,<?php echo $a; ?>,event);" onkeyup="return update_by_price(this.value,<?php echo $a; ?>);" name="p_price[]" id="p_price_<?php echo  $a; ?>" type="text" value="" />
		<?php }else{ ?>
		...
		<?php } ?>
			  ...
			  <td class="text-left" id="td_p_qnty_<?php echo  $a; ?>">
			   <?php if(empty($created_po)){ ?> 
                              <input  required="required" onkeypress="return remove_zero_q(this.value,<?php echo $a; ?>,event);" onkeyup="return update_by_q(this.value,<?php echo $a; ?>);" class="form-control" name="p_qnty[]" id="p_qnty_<?php echo  $a; ?>" type="text" value="" />
			<?php }else{ ?>
		...
		?>
         ...
         <?php if(empty($created_po)){ /*onclick="return check_ware_house_quantity();"*/?>
            
            <input type="submit"  onclick="checkshop();" class="btn btn-primary pull-right" id="cr_btn" value="Create Credit Note" />
  ...
  -->
   ...
   <textarea name="rem" class="form-control"  id="rem" style="margin-top:10px;" placeholder="Enter Your Text..."></textarea>
	</div>
	</form>
  </div>
...
function check_ware_house_quantity()
{
   ...
   var activity=$("#activity").val();
    ...
    var url = 'index.php?route=creditnote/creditnote/view_creditnote_details&token=<?php echo $token; ?>';
...
function get_ship_to_data(store_id)
{
   ...
   if((store_id!="") && (store_id!="0"))
    {
        $.ajax({
            url: 'index.php?route=creditnote/creditnote/get_to_store_data_b2b&token=<?php echo $token; ?>&store_id=' +  encodeURIComponent(store_id),
            ...
            success: function(json) {
                ...
                $("#ship_to_phone").html(data[3]);
                $("#ship_to_email").html(data[2]);
               // $("#ship_to_pan").html(data[4]);
                 $("#ship_to_gstn").html(data[4]);
...
function add_row(a)
{
    ...
    var html='<tr id="tr_'+count+'">'+
			  ...
			  '<td class="text-left" id="td_sid_'+count+'">'+count+'</td>'+
                          '<td id="td_p_inventory_'+count+'" class="text-left"> <input type="text" class="form-control" name="activity[]" /></td>'+
			  ...
			  '<td style="display:none;" class="text-left" id="td_p_tax_type_'+count+'">'+
			  '</td>'+
