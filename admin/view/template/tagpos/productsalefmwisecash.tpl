...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1><?php echo "Product Sale Fm Wise (Cash)"; ?></h1>
 ...
 <div class="form-group">
        ...
        <div class="table-responsive">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <?php if ($orders) { $total=0; if($_GET["page"]=="") {$aa=1;} else if($_GET["page"]=="1") {$aa=1;}
		...
		<span style="font-weight: bold;">Page Total :: Total Amount : <?php echo number_format((float)$total, 2, '.', ''); ?></span> 
...
$('#button-filter').on('click', function() {
	...
	url = 'index.php?route=tagpos/fmdelivery/productsalefmwisecash&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=tagpos/fmdelivery/download_excelproductsalefmwisecash&token=<?php echo $token; ?>';
