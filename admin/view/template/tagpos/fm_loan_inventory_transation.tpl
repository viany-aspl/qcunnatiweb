...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <h1><?php echo "FM Loan Issue Transation"; ?></h1>
...
<?php if ($error) {  ?>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-bar-chart"></i> <?php echo "FM Loan Issue Transation"; ?></h3>
		<button type="button" id="button-download_trans" class="btn btn-primary pull-right" 
 ...
 <div class="form-group">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><?php echo date('Y-m-d',strtotime($order['issue_date'])); ?></td>
				
                 <td>
                      <a   class="btn btn-primary" onclick="getupdateqty('<?php echo $order['id'];?>');" value="<?php echo $order['id'];?>" data-toggle="modal"  data-target="#myModal"><i class="fa fa-pencil"></i></a>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
	  ...
	  <input  name="fid" type="hidden"  value="" id="qid" class="form-control" />
       <input type="text" name="quantity" onkeypress="return isNumber(event)"  placeholder="Quantity" id="qty" class="form-control" />
      </div>
      <div class="modal-footer">
       <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" id="link_span1" onclick="submitValume();" class="btn btn-primary">Save changes</button>
      </div>
    </div>
  ...
  function getupdateqty(id){
		...
		function submitValume(){
         
        var id=$('#qid').val();
		//alert(id);
		var quantity=$('#qty').val();
		//alert(quantity);
		var utl='index.php?route=tagpos/loan_inventory/updatequantity&token=<?php echo $token; ?>'+'&id='+id+'&quantity='+quantity;
      	$.ajax({ 
        type: 'post',
        url: utl,
...
$('#button-filter').on('click', function() {
	...
	url = 'index.php?route=tagpos/loan_inventory/fm_loan_inventory_isseu_trans&token=<?php echo $token; ?>';
...
$('#button-download_trans').on('click', function() {
	url = 'index.php?route=tagpos/loan_inventory/download_excelfmloanissue&token=<?php echo $token; ?>';
