...
<div id="content">
    ...
    <?php } ?>
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="<?php echo $breadcrumb['href']; ?>">ISEC Requisition</a></li>
        <?php } ?>
      </ul>
    </div>
  </div>
		  ...
		  ?>
            <tr>
			  ...
			  <td class="text-left" style="width: 20%;">
									...
									<option value="26">IFFCO E Bazzar</option>
									<option value="27">MOSAIC Mosaic</option>
									<option value="28">INDIAN POTASH LIMITED</option>
									<option value="29">JUBLIANT AGRI AND CONSUMER PRODUCTS</option>
									<option value="30">BAYERS Bayers</option>
									<option value="33">PI Industries</option>
									<option value="34">Crystal Crop Protection Private Ltd.</option>
									<option value="32">Dhanuka Agri Tech</option> 
