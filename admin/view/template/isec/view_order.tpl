		...
		<table class="table table-bordered" id="print_table" border="1">
          <thead>
            <tr>
			  ...
			  <td class="text-left" style="width: 11.11%;">Supplier/OTP</td>
		  ...
		  ?>
            <tr>
			  ...
			  <td class="text-left">
			  <?php echo $product['supplier_name']; if(!empty($order_information['order_info']['driver_otp'])){ echo '/'.$order_information['order_info']['driver_otp']; } ?>
			  </td>
			  <td class="text-left">
