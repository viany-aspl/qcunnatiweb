...
<td class="text-left"><?php if ($sort == 'p.pricetax') { ?>
...
<td class="text-left"><?php if ($product['special_tax']) { ?>
                  ...
                  if ($product['quantity'] <= 0) { ?>
                    <span data-toggle="tooltip"  class="label label-warning"><?php echo $productsquantity//$product['quantity']; ?></span>
                    <?php } elseif ($product['quantity'] <= 5) { ?>
                    <span data-toggle="tooltip"  class="label label-danger"><?php echo $productsquantity//$product['quantity']; ?></span>
                    <?php } else { ?>
                    <span data-toggle="tooltip"  class="label label-success"><?php echo $productsquantity//$product['quantity']; ?></span>
                    <?php } ?></td>
					<?php } ?>
				  ...
				  <?php if($user_group_id!='35'){ ?>
					  ...
					  <?php } ?>
                      <a href="<?php echo $product['edit_quantity']; ?>" data-toggle="tooltip" title="Edit product price" class="btn btn-danger"><i class="fa fa-pencil-square-o"></i></a>
                  </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=isec/isecproduct&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=isec/isecproduct/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
