...
<div id="content">
  ...
  <div class="container-fluid">
   ...
   <?php  }  ?>
                      ...
                      <?php  }  ?>
                       <td>
					  <input type="text" name="tax_class_id<?php echo $store_quantity['title'] ; ?>" readonly  placeholder="<?php echo "Tax"; ?>" value="<?php echo $store_quantity['title'] ; ?>" id="input-tax_class_id<?php echo $store_quantity['title'] ; ?>" class="form-control" /> 
