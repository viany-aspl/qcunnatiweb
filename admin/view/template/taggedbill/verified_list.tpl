...
<div id="content">
  ...
  <div class="container-fluid">
	...
	<td class="text-left">Amount</td>
	 ...
	 <td class="text-left">Verification date</td>
              </tr>
            </thead>
            <tbody>
	...
	<td class="text-left"><?php if($order['status']=="0") { echo "<span style='color: orange;'>Pending</span>"; } else if($order['status']=="1") { echo "<span style='color: green;'>Accepted</span>"; } else if($order['status']=="2") { echo "<span style='color: red;'>Rejected</span>"; } ?></td>
              <td class="text-left"><?php echo $order['accepted_user']; ?></td>
	<td class="text-left"><?php echo $order['accepted_date']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=taggedbill/bill/history&token=<?php echo $token; ?>';
