...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/inventory_report/product_wise&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() { 
	url = 'index.php?route=reportdscl/inventory_report/download_excel_product_wise&token=<?php echo $token; ?>';
