  ...
  <div class="container-fluid">
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
	        ...
	        <td class="text-left">Contractor ID <?php //echo $column_title; ?></td>
                <td class="text-left">Order ID <?php //echo $column_title; ?></td>
	        ...
	        <td class="text-right">Total<?php //echo $column_total; ?></td>
                <td class="text-right">Credit/Debit<?php //echo $column_total; ?></td>
                <td class="text-right">Transaction Type<?php //echo $column_total; ?></td>
	...
	?>
	        ...
	        <td class="text-right"><?php echo number_format((float)$order['tax'], 2, '.', ''); ?></td>
                ...
                <td class="text-right"><?php echo $order['cr_dr']; ?></td>
                <td class="text-right"><?php echo $order['transaction_type']; ?></td>
                <td class="text-right"><?php echo $order['crdate']; ?></td>
              </tr>
              <?php 
              $aa++;
              } ?>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=report/contractor_report/get_contractor_trans&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=report/contractor_report/get_contractor_trans_download_excel&token=<?php echo $token; ?>';
