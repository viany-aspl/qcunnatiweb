...
<?php } ?>
	...
	<td class="text-right"><?php if($order['user_status']==0){ echo 'De-active'; } else if($order['user_status']==01) { echo 'Active'; } ?></td>
              </tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/cash_report/cash_position&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=reportdscl/cash_report/download_cash_position_excel&token=<?php echo $token; ?>';
