...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliationspray&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliationspray/download_excel&token=<?php echo $token; ?>';
...
$('#button-details').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliationspray/download_item_excel&token=<?php echo $token; ?>';
