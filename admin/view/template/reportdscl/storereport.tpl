...
$('#button-filter').on('click', function() {
	 url = 'index.php?route=reportdscl/storereport&token=<?php echo $token; ?>';
	 //url += '&page='+'1';
         //url += '&tab='+'1';
...
<script type="text/javascript">
	...
	url = 'index.php?route=reportdscl/stock/download_recived_for_store_report&token=<?php echo $token; ?>';
...
$('#button-download2').on('click', function() {
	url = 'index.php?route=reportdscl/stock/download_transfer&token=<?php echo $token; ?>';
...
$('#button-download3').on('click', function() {
    url = 'index.php?route=reportdscl/sale_summary/download_excel_subsidycash&token=<?php echo $token; ?>';
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
   ...
   $('#button-download4').on('click', function() {
    url = 'index.php?route=reportdscl/cash_report/download_excel&token=<?php echo $token; ?>';
 ...
 $('#button-download5').on('click', function() {
    url = 'index.php?route=reportdscl/product_storewisesales/download_excel&token=<?php echo $token; ?>';
  ...
  $('#button-download6').on('click', function() {
    url = 'index.php?route=reportdscl/inventory_report/download_excel&token=<?php echo $token; ?>';
...
$('#button-download7').on('click', function() {
    url = 'index.php?route=reportdscl/sale_summary/download_excel_category_date_wise&token=<?php echo $token; ?>';
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
...
$('#button-download8').on('click', function() {
    url = 'index.php?route=reportdscl/expenseapprove/getlist_download&token=<?php echo $token; ?>';
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
