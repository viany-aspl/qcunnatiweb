...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/cash_report/runner_cash_position&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=reportdscl/cash_report/download_runner_current_postion_excel&token=<?php echo $token; ?>';
