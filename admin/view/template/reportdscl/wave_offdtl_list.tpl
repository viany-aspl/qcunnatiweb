          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select name="filter_stores_id" style="width: 100%" id="input-store" class="select2 form-control">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/debitstore/getWaveoffdata&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/debitstore/getWaveoffdata_download&token=<?php echo $token; ?>';
