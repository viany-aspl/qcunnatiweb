...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            <thead>
              <tr>
	<td class="text-right">Supplier Name(Sender)</td>
	...
	<td class="text-right"  style="color: red;font-weight: bold;" ><?php echo $order['To_be_Recived']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/stock/transit_po&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/stock/download_transit_po&token=<?php echo $token; ?>';
