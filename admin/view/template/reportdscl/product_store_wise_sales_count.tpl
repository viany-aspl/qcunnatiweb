...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/product_storewisesales/salescount&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/product_storewisesales/download_excel_salescount&token=<?php echo $token; ?>';
