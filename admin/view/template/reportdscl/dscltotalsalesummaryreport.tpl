...
<div id="content">
  <div class="page-header">
    <div class="container-fluid"> 
      <h1>DSCL Order Amount Summary Report</h1>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i>DSCL Order Amount Summary Report</h3>
...
<button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
 ...
 <div class="col-sm-6 ">
	  ...
	  <td class="text-left">Tagged Cash(Tagged Amount only)</td>				
	  <td class="text-left">Cash Subsidy(Order count only)</td>
...
var url = 'index.php?route=reportdscl/dscltotalsalesummaryreport&token=<?php echo $token; ?>';
