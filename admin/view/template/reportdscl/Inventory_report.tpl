...
<div id="content">
  ...
  <div class="container-fluid">
	...
	&nbsp;
	<button type="button" id="button-download_all" class="btn btn-primary pull-right" style="margin-top: -8px;margin-right: 30px;"> Download All Stores Inventory</button>
      </div>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/inventory_report&token=<?php echo $token; ?>';
...
$('#button-download_all').on('click', function() {
    url = 'index.php?route=reportdscl/inventory_report/download_all_stores_products&token=<?php echo $token; ?>';
