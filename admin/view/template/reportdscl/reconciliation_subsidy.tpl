  ...
  <div class="modal fade" id="myModal_create_bill" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="index.php?route=reportdscl/reconciliationsubsidy/create_bill&token=<?php echo $token; ?>" method="post" enctype="multipart/form-data" onsubmit="return myFunction()" >
            <div class="form-group">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliationsubsidy&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliationsubsidy/download_excel&token=<?php echo $token; ?>';
...
$('#button-pdf').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliationsubsidy/download_pdf&token=<?php echo $token; ?>';
...
$('#button-details').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliationsubsidy/download_item_excel&token=<?php echo $token; ?>';
