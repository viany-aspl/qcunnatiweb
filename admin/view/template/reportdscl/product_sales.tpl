...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/product_sales&token=<?php echo $token; ?>';
...
$('#button-download-csv').on('click', function() {
    url = 'index.php?route=reportdscl/product_sales/download_csv&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=reportdscl/product_sales/download_excel&token=<?php echo $token; ?>';
