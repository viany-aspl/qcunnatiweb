          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <select name="filter_stores_id" id="input-status" class="form-control" onchange="return show_download(this.value);">
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/leadger&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/leadger/download_pdf&token=<?php echo $token; ?>';
