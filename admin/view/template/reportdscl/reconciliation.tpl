    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="table-responsive">
			<span style="font-weight: bold;">Total Order Amount : <?php echo number_format((float)$total_order_amount_all, 2, '.', ''); ?></span> 
			|| <span style="font-weight: bold;">Total Tagged Amount : <?php echo number_format((float)$total_tagged_amount_All, 2, '.', ''); ?></span>
			|| <span style="font-weight: bold;">Total Cash Amount : <?php echo number_format((float)$total_cash_amount_all, 2, '.', ''); ?></span>
			|| <span style="font-weight: bold;">Total Subsidy Amount : <?php echo number_format((float)$total_subsidy_amount_all, 2, '.', ''); ?></span>	
                           <br/><br/>
          <table class="table table-bordered" style="font-size: 94%;">
            <thead>
              <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliation&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliation/download_excel&token=<?php echo $token; ?>';
...
$('#button-pdf').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliation/download_pdf&token=<?php echo $token; ?>';
...
$('#button-details').on('click', function() {
	url = 'index.php?route=reportdscl/reconciliation/download_item_excel&token=<?php echo $token; ?>';
