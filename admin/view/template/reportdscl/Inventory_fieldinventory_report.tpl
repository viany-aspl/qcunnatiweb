...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/inventory_report/field_inventory_report&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=reportdscl/inventory_report/field_inventory_report_download&token=<?php echo $token; ?>';
