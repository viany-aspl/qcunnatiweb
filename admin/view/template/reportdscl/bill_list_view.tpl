...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/billsubmission/getlist&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportdscl/billsubmission/getlist_download&token=<?php echo $token; ?>';
