...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportdscl/sale_summary/sale_summary&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=reportdscl/sale_summary/download_excel_sale_summary&token=<?php echo $token; ?>'; 
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
