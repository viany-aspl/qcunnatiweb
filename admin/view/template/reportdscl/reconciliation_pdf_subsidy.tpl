...
Letter No. - ASPL-<?php echo $file_aspl; ?>
	...
	<th class="text-right">Material BiIlled</th>
            ...
            <tbody style="font-size: 10px !important;">
              ...
              <tr >
                ...
                <td class="text-left" style="font-size: 12px;text-align: left;"><?php echo $order['payment_method']; ?></td>
	...
	<td class="text-right" style="font-size: 12px;"><?php echo $order['o_bill_no']; ?></td>
                ...
                <td class="text-right" style="text-align: left;font-size: 8px;width: 90px;"><span style="font-size: 10px;"><?php echo $order['farmer_name']; ?> </span>
	...
	<td class="text-right"></td>
                ...
                <td class="text-right" style=""><?php echo number_format((float)$total, 2, '.', ''); ?></td>
