...
<div id="content">
  <div class="page-header">
    <div class="container-fluid"> 
      <h1>DSCL Order Summary Report</h1>
  </div>
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-list"></i>DSCL Order Summary Report</h3>
        ...
        <div class="col-md-12" >                                   
            ...
            <thead>
              <tr>
                ...
                <td class="text-left">Total Orders</td>
...
var url = 'index.php?route=reportdscl/dsclsalesummaryreport&token=<?php echo $token; ?>';
