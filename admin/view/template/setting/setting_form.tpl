...
<script>
 function isUrlValid(userInput,id) 
 {
	...
	<div class="form-group required">
                ...
                <div class="col-sm-10">
                  <!--<select name="config_unit" id="input-factoryunit" class="form-control">
	      <option value="">Select Factory Unit</option>
                    <?php foreach ($unit_list as $unit_list1) { ?>
                    <?php if ($unit_list1['unit_id'] == $config_unit) { ?>
                    <option value="<?php echo $unit_list1['unit_id']; ?>" selected="selected"><?php echo $unit_list1['unit_name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $unit_list1['unit_id']; ?>"><?php echo $unit_list1['unit_name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>-->
                    ...
                    <!--
                         <?php 
                            ...
                            foreach ($unit_list as $unit_list1) {
                                ...
                                ?>
                                <?php if (in_array($unit_list1['unit_id'], $config_unit)) //$unit_list1['unit_id'] == $config_unit) 
                                { ?>
	...
	<div class="form-group required">
                ...
                <div class="col-sm-10">
                  <select required name="config_storetype" id="input-storetype" class="form-control" onchange="show_hide_firm(this.value);">
...
function checkFileSize()
    ...
    else if(($("#input-url").val()=="") || ($("#input-name").val()=="") || ($("#input-owner").val()=="") || ($("#input-storetype").val()=="") || ($("#input-creditlimit").val()=="") || ($("#input-address").val()=="") || ($("#input-head_office").val()=="") || ($("#input-email").val()=="") || ($("#input-telephone").val()==""))
    {
