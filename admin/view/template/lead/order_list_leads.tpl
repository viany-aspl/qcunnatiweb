  ...
  <div class="container-fluid">
	...
	<div class="form-group">
            ...
            <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label" for="input-total">Added By </label>
               <select name="filter_addedby" id="input-addedby" class="form-control">
                  <option value="">SELECT</option>
                 
                  <!--<option value="11" <?php if($filter_addeddby=="11") { ?> selected="selected" <?php } ?> >Store In-Charge</option>-->
                  <option value="26" <?php if($filter_addeddby=="26") { ?> selected="selected" <?php } ?> >ASE</option>
                </select>
              </div>
            </div>
            <div class="col-sm-4">
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-right"><?php if ($sort == 'o.total') { ?>
                    ...
                    <?php } ?></td>
	<td class="text-left">Converted Total</td>
...
<td class="text-right"><?php echo $column_action; ?></td>
	...
	<td class="text-left"><?php echo $order['aTotal']; ?></td>
...
$('#button-filter').on('click', function() {
	...
	var filter_addeddby = $('#input-addedby').val();

	if (filter_addeddby) {
		url += '&filter_addeddby=' + encodeURIComponent(filter_addeddby);
	}	
