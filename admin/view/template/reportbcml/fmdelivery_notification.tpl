  ...
  <script type="text/javascript">
      jQuery('#myModal_invoice').on('show.bs.modal',function(e){
         ...
         // var store = jQuery(e.relatedTarget).data('store');
          var url = 'index.php?route=reportbcml/order/invoiceDetail&token=<?php echo $token; ?>';
          jQuery(e.currentTarget).find('.modal-title').text(jQuery(e.relatedTarget).data('title'));
          jQuery.post(url,{filter_invoice:inv_id},function(dta){
              if(dta.status=='error'){
...
//          return false;
          jQuery.post('index.php?route=reportbcml/order/SendInvoiceSMSNotification&token=<?php echo $token; ?>',
...
$('#button-filter').on('click', function() {
	...
	url = 'index.php?route=reportbcml/order/deliveryNotification&token=<?php echo $token; ?>';
