...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportbcml/reconciliationspray&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportbcml/reconciliationspray/download_excel&token=<?php echo $token; ?>';
...
$('#button-details').on('click', function() {
	url = 'index.php?route=reportbcml/reconciliationspray/download_item_excel&token=<?php echo $token; ?>';
