...
<button type="button" id="button-details" class="btn btn-primary pull-right" style="margin-top: -8px !important; margin-right: 10px !important;">
	...
	<td  class="text-right">Order ID</td>
   	 <td  class="text-right">Inv no.</td>
                ...
                <td class="text-right">Name/Village Code</td>
...
<!-- Modal -->
  <div class="modal fade" id="myModal_create_bill" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Create Duplicate Bill</h4>
        </div>
        <div class="modal-body">
        <form action="index.php?route=reportbcml/reconciliation/create_bill_duplicate&token=<?php echo $token; ?>" method="post" enctype="multipart/form-data" onsubmit="return myFunction()" >
            <div class="form-group">
	...
	<div class="form-group">
                <label class="control-label" for="input-date">End Date</label>
                <div class="input-group date" id="date_cr">
                  <input required type="text" name="filter_date_end"  placeholder="" data-date-format="YYYY-MM-DD" id="input-date" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span></div>
              </div>
	<div class="form-group">
                <label class="control-label" for="input-bill">Bill Number</label>
                <div class="input-group" id="bill" style="width: 100%;" >
                  <input required type="text" name="filter_number" autocomplete="off" style="width: 100%;"  placeholder="Bill Number"  id="input-bill_number" class="form-control" />
                  </div>
              </div>
	<div class="form-group">
                <label class="control-label" for="input-bill">Invoice  Number (Coma Seperated)</label>
                <div class="input-group" id="bill" style="width: 100%;" >
                  <input required type="text" name="invoice_number" autocomplete="off" style="width: 100%;"  placeholder="Invoice Number"  id="input-invoice_number" class="form-control" />
                  </div>
              </div>
            <div class="form-group">
...
function myFunction() {
	...
	if ( (filter_date!= '') && (filter_store != '') && (filter_unit != '') && (bill_number!='') ){
