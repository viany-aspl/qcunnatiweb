...
$('#button-filter').on('click', function() {
	 url = 'index.php?route=reportbcml/storereport&token=<?php echo $token; ?>';
	 //url += '&page='+'1';
         //url += '&tab='+'1';
...
<script type="text/javascript">
	...
	url = 'index.php?route=reportbcml/stock/download_recived_for_store_report&token=<?php echo $token; ?>';
...
$('#button-download2').on('click', function() {
	url = 'index.php?route=reportbcml/stock/download_transfer&token=<?php echo $token; ?>';
