    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <select required name="filter_store" style="width: 100%;" id="input-store" class="select2 form-control" onchange="return get_stores_data(this.value);">
		...
		<?php foreach($units as $unit) {  ?>
				<option value="<?php echo $unit['unit_name']; ?>" <?php if ($unit['unit_name'] == $filter_unit) { ?> selected="selected" <?php } ?>><?php echo $unit['unit_name']; ?></option> 
			<?php } ?>
                    </select>
              </div>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportbcml/billsubmission/getlist&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportbcml/billsubmission/getlist_download&token=<?php echo $token; ?>';
