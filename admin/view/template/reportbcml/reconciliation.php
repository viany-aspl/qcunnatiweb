...
public function getdebitnotedetail() {
	echo 'getdebitnotedetail called'; exit;
		$this->load->language('report/reconciliation');
		...
		{
			echo 'here';
			echo $results = $this->model_pos_bcml->GetDebitNoteDetail('GetDebitNoteDetail',$filter_data);
		}
		$TotalTaggedValue=0;
		if (is_array($results)
		{
		...
		else
		{
			...
			echo $data['text_no_results']=$results;
		}
