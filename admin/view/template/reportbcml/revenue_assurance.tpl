...
<?php if ($error) {  ?>
	...
	<span style="font-weight: bold;">Total Tagged Amount : <?php echo number_format((float)$total_tagged_amount_All, 2, '.', ''); ?> &nbsp; || &nbsp; Total Cash Amount : <?php echo number_format((float)$total_cash_amount_All, 2, '.', ''); ?></span> 
	...
	<td class="text-right"><?php echo number_format((float)$order['cash'], 2, '.', ''); ?></td>
		...
		<span style="font-weight: bold;">Page Total :: Total Tagged Amount : <?php echo number_format((float)$total_tagged_amount, 2, '.', ''); ?> &nbsp; || &nbsp; Total Cash Amount : <?php echo number_format((float)$total_cash_amount, 2, '.', ''); ?></span> 
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportbcml/revenue_assurance&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportbcml/revenue_assurance/download_excel&token=<?php echo $token; ?>';
