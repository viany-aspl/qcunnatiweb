        ...
        <div class="table-responsive">
            ...
            <thead>
              <tr>
				...
				<th class="text-right" style="width: 30%;">Material BiIlled</th>
		 ...
		 <table border="0" cellspacing="0" cellpadding="0" class="table table-bordered" style="width: 100%;font-size: 7px;" >
            			<thead style="font-size: 7px !important;">
              			<tr>
                				...
                				<th class="text-left" style="font-size: 7px !important;width: 10%;">Qnty</th>
					<!--<th class="text-left" style="font-size: 7px !important;width: 10%;">Rate</th>
					<th class="text-left" style="font-size: 7px !important;width: 10%;">Amount</th>-->
					<th class="text-left" style="font-size: 7px !important;width: 10%;">SubSidy(%)</th>
					<th class="text-left" style="font-size: 7px !important;width: 25%;">Sub Cat</th>
				</tr>
			</thead>
		<?php foreach($order['orderproducts'] as $products){ 
			if(empty($products['SUBSIDY_CAT_DESC']))
			{
				$products['SUBSIDY_CAT_DESC']='NA';
			}
		?>	
		<tr>
			...
			<td class="text-right" style="text-align: center;font-size: 8px;">
				<span style="font-size: 8px;"><?php echo number_format((float)($products['SubSidyPer']),2,'.',''); ?>  </span>
			</td>
			<td class="text-right" style="text-align: center;font-size: 8px;">
				<span style="font-size: 8px;"><?php echo $products['SUBSIDY_CAT_DESC']; ?>  </span>
			</td>
		</tr>
		<?php } ?>
		</table>
