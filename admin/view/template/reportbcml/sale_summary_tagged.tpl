...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportbcml/sale_summary_tagged&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
    url = 'index.php?route=reportbcml/sale_summary_tagged/download_excel&token=<?php echo $token; ?>';
    	var filter_date_start = $('input[name=\'filter_date_start\']').val();
