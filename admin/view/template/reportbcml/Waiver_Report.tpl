...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportbcml/debitstore/waiver_report&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportbcml/debitstore/waiver_report_download&token=<?php echo $token; ?>';
