...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportbcml/debitstore/getWaveoffdata&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportbcml/debitstore/getWaveoffdata_download&token=<?php echo $token; ?>';
