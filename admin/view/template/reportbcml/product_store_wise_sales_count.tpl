...
$('#button-filter').on('click', function() {
	url = 'index.php?route=reportbcml/product_storewisesales/salescount&token=<?php echo $token; ?>';
...
$('#button-download').on('click', function() {
	url = 'index.php?route=reportbcml/product_storewisesales/download_excel_salescount&token=<?php echo $token; ?>';
