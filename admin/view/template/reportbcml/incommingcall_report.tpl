...
<td class="text-left">General Call</td>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-left"><?php echo $activity['calldate']; ?></td>
                <td class="text-left"><?php echo $activity['callcount']; ?></td>
<td class="text-left"><?php echo $activity['Answered']; ?></td>
<td class="text-left"><?php echo $activity['pending']; ?></td>
<td class="text-left"><?php echo $activity['Busy']; ?></td>
<td class="text-left"><?php echo $activity['Not_reachable']; ?></td>
<td class="text-left"><?php echo $activity['Attempt_Later']; ?></td>
<td class="text-left"><?php echo $activity['Not_Interested']; ?></td>
<td class="text-left"><?php echo $activity['Switch_Off']; ?></td>
<td class="text-left"><?php echo $activity['Not_Picking']; ?></td>
<td class="text-left"><?php echo $activity['Enquiry_Status']; ?></td>
<td class="text-left"><?php echo $activity['General_Call']; ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
              <tr>
