  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <!--<td class="text-left">Current Call Status</td>-->
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><a href="#" onclick="return show_customer_data(<?php echo $order['telephone']; ?>,<?php echo $order['call_status']; ?>,'<?php echo $order['firstname']; ?>','<?php echo $order['lastname']; ?>');"><?php echo $order['telephone']; ?></a></td>
         ...
         -->
          ...
          <li class="active"><a href="#tab-history"  data-toggle="tab">Fill Form</a></li>
            ...
            <div class="tab-content">
               ...
               <input type="hidden" name="current_order_status" id="current_order_status" value="9" />
               ...
               <div class="form-group" style="text-align: left;">
                ...
                <select name="txt_response" id="txt_response" class="form-control">
                 ...
                 <option value="Not Good">Not Good</option>
               	...
               	<div class="form-group" style="text-align: left;">
                <label class="control-label" for="input-order-status">Reason of response</label>
                <textarea name="Reason_of_response" class="form-control" id="Reason_of_response" placeholder="Reason of response"></textarea>
              </div>
              <div class="form-group" style="text-align: left;">
      ...
      <script>
          ...
          function show_customer_data(mobile,call_status,firstname,lastname)
          {   //order_id=36;
              
              $.ajax({
              url: 'index.php?route=ccare/ccare/get_customer_info&token=<?php echo $token; ?>&mobile=' +  encodeURIComponent(mobile),
              // dataType: 'json',
               success: function(json) 
               {
                   ...
                   $("#farmer_first_name").val(firstname);
                   $("#farmer_last_name").val(lastname);
               }
