...
<button type="button" id="button-download" class="btn btn-primary pull-right" style="margin-top: -8px !important;">
	...
	<td class="text-left">Date discussed</td>              
              </tr>
            </thead>
            <tbody>
              <?php if ($activities) { ?>
              ...
              <tr>
	  <td class="text-left"><?php echo $activity['transid']; ?></td>
                <td class="text-left"><?php echo $activity['mobile']; ?></td>
                <td class="text-left"><?php echo $activity['STATUS_NAME']; ?></td>
                <td class="text-left"><?php echo $activity['Acres']; ?></td>
                <td class="text-left" style="max-width: 200px;"><?php echo $activity['query']; ?></td>
                <td class="text-left" style="max-width: 200px;"><?php echo $activity['solution']; ?></td>
               <td class="text-left"><?php echo $activity['datediscussed']; ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
              <tr>
...
$('#button-download').on('click', function() {
	url = 'index.php?route=ccare/incommingcall/download_reports&token=<?php echo $token; ?>';
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=ccare/incommingcall/report/&token=<?php echo $token; ?>';
