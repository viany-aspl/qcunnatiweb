            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left" style="max-width: 100px;">Reason of response</td>
...
$('#button-download').on('click', function() {
	url = 'index.php?route=ccare/ccare/download_reports_completed&token=<?php echo $token; ?>';
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=ccare/ccare/get_reports_completed&token=<?php echo $token; ?>';
